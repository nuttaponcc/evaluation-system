...
<div align="left">
  <p><strong>แก้ไข</strong>
    <?php 
     	$query = "SELECT * FROM `research2`  where  `research2`.id=$id  and  userid=$userid ORDER BY date asc";
  ...
  <form action="action-admin/edit-research2.php?<? echo "userid=$userid" ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
