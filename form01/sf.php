...
<table border="0" cellpadding="5" cellspacing="2" bgcolor="#666666">
  ...
  <tr>
    ...
    <td align="left" valign="top" bgcolor="#FFCCCC">&nbsp;</td>
    <td align="right" valign="top" bgcolor="#FFCCCC">&nbsp;</td>
    <td align="left" valign="top" bgcolor="#FFCCCC"><a href="index.php?menu=eval-lectures-add" target="_parent"></a>      </td>
  </tr>
   <?
...
//	echo "$query";
  ...
  ?>
  <tr>
    <td align="left" valign="top" bgcolor="#FFCCCC">1.3) ผู้ประสานงานรายวิชา (2 กลุ่มขึ้นไปในรายวิชาพื้นฐาน ) </td>
    <td align="center" valign="top" bgcolor="#FFCCCC"><font  size="-3">(หน่วยกิต)x(ภาระงาน)x(สัปดาห์)x(ตัวคูณ)</font></td>
    <td align="left" valign="top" bgcolor="#FFCCCC">&nbsp;</td>
    <td align="right" valign="top" bgcolor="#FFCCCC">&nbsp;</td>
    <td align="left" valign="top" bgcolor="#FFCCCC">&nbsp;</td>
...
<tr>
   ...
   <?
   	$query = "SELECT * FROM `course`,`rm`  where rm.courseid=course.id and  userid='".$id."' ORDER BY date asc";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	 $n=$row['multiplier']*15;
	 $sum=$sum+$n;
  ...
  <tr>
    ...
    <td align="left" valign="top" bgcolor="#FFCCCC">&nbsp;</td>
          ...
          <?
   	$query = "SELECT * FROM `edu`  where   `userid`='".$id."' ORDER BY date asc";
	//echo "$query";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
		echo "
  ...
  <tr>
   ...
   <td align=\"left\" valign=\"top\" bgcolor=\"#E8FFE8\">";
	...
	echo "</td>    <td align=\"left\" valign=\"top\" bgcolor=\"#E8FFE8\">&nbsp;</td>
    <td align=\"left\" valign=\"top\" bgcolor=\"#E8FFE8\">
	</td>
  </tr>	
		";
  ...
  <tr>
    ...
    <td align="left" valign="top" bgcolor="#C8E234">&nbsp;</td>
                   ...
                   <?
   	$query = "SELECT * FROM `workload`,`research2`  where  `workload`.`id` = `research2`.`workload`   and `userid`='".$id."' ORDER BY date asc";
	//echo "$query";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	 		$n=$row['score']*$row['multiplier'];
 ...
 <tr>
  ...
  <tr>
    ...
    <td align="left" valign="top" bgcolor="#C8E234">&nbsp;</td>
                    ...
                    <?
   	$query = "SELECT * FROM `research4`  where    `userid`='".$id."' ORDER BY date asc";
	//echo "$query";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	 		$n=$row['multiplier'];
  ...
  <tr>
    ...
    <td align="center" valign="top" bgcolor="#BAE94B"><font  size="-3">(ภาระงาน)x(ตัวคูณ)</font></td>
  ...
  <tr>
    ...
    <td align="left" valign="top" bgcolor="#BAE94B">&nbsp;</td>
                      ...
                      <?
   	$query = "SELECT * FROM `research54`  where    `userid`='".$id."' ORDER BY date asc";
	//echo "$query";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
 		$n=$row['multiplier']*$row['percent']/100;
...
//	echo "$query";
  ...
  <tr>
    ...
    <td align="left" valign="top" bgcolor="#B8F1F0">&nbsp;</td>
        ...
        <?
   	$query = "SELECT * FROM `workload`,`service2`  where  `service2`.`weight`=`workload`.`id` and  userid='".$id."' ORDER BY date asc";
	//echo "$query";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
...
<tr>
    ...
    <td align="left" valign="top" bgcolor="#B8F1F0">&nbsp;</td>
        ...
        <?
   	$query = "SELECT * FROM `workload`,`service3`  where  `service3`.`weight`=`workload`.`id` and  userid='".$id."' ORDER BY date asc";
	//echo "$query";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
  ...
  <?
     	$query = "SELECT * FROM `workload`,`other`  where  `other`.`weight`=`workload`.`id` and  `workload`.`category`=22 and   userid='".$id."' ORDER BY date asc";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	 		$n=$row['score']*$row['multiplier'];
     if($row['id']==50)$txt="(".$row['name'].")"; else $txt="";
  ...
  <?
     	$query = "SELECT * FROM `workload`,`other`  where  `other`.`weight`=`workload`.`id` and  `workload`.`category`=23 and   userid='".$id."' ORDER BY date asc";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	 		$n=$row['score']*$row['multiplier'];
     if($row['id']==50)$txt="(".$row['name'].")"; else $txt="";
