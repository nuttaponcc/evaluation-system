...
<div align="left">
  <p><strong>แก้ไข</strong><?php 
     	$query = "SELECT * FROM  `edu`  where  `edu`.id=$id  and  userid=$userid ORDER BY date asc";
  ...
  <form action="action-admin/edit-edu.php?<? echo "userid=$userid" ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table border="0" cellpadding="5" bgcolor="#FFFFFF">
    <tr>
      <td width="150" align="left" valign="top" bgcolor="#FFDDFF"><input name="id" type="hidden" value="<? echo $id ?>" /> 
      รหัสวิชา </td>
      <td align="left" valign="top" bgcolor="#FFDDFF"><input name="name" type="text" id="name" value="<? echo $row0['name']; ?>" /></td>
      <td align="left" valign="top" bgcolor="#FFDDFF">&nbsp;</td>
    </tr>
    <tr>
      <td align="left" valign="top" bgcolor="#FFDDFF">ชื่อวิชา</td>
      <td align="left" valign="top" bgcolor="#FFDDFF"><input name="sname" type="text" id="name2" value="<? echo $row0['sname']; ?>" /></td>
      <td align="left" valign="top" bgcolor="#FFDDFF">&nbsp;</td>
    </tr>
    <!--tr>
