...
<table width="100%" border="0" cellpadding="5" cellspacing="2"  id="customers02">
    <tr>
      ...
      <th align="left" valign="top" bgcolor="#65C0ED"><div align="center">ไฟล์เอกสารประกอบ</div></th>
    ...
    <tr>
      ...
      <td align="left" valign="top" bgcolor="#CCCCCC">
        <? if ($lock03==0) { ?>    <a href="index.php?menu=eval-lectures-add" target="_parent"><img src="images/add.png" alt="add" width="100" height="30" border="0" />
...
if ($lock03==0) 	echo "</td>
  ...
  ?>
    <tr>
      ...
      <td align="right" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="left" valign="top" bgcolor="#CCCCCC">
        <? if ($lock03==0) { ?>    <a href="index.php?menu=eval-practices-add" target="_parent"><img src="images/add.png" alt="add" width="100" height="30" border="0" />
...
//	echo "$query";
  ...
  ?>
    <tr>
      ...
      <td align="right" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="left" valign="top" bgcolor="#CCCCCC">
        <? if ($lock03==0) { ?>    <a href="index.php?menu=eval-coordinator-add" target="_parent"><img src="images/add.png" alt="add" width="100" height="30" border="0" />
...
//	echo "$query";
  ...
  ?>
    <tr>
      ...
      <td align="right" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="left" valign="top" bgcolor="#CCCCCC">
        <? if ($lock03==0) { ?>    <a href="index.php?menu=eval-internships-add" target="_parent"><img src="images/add.png" alt="add" width="100" height="30" border="0" />
...
if ($lock03==0)  echo "   
  ...
  ?>
    <tr>
      ...
      <td align="right" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="left" valign="top" bgcolor="#CCCCCC">
        <? if ($lock03==0) { ?>    <a href="index.php?menu=eval-ug-advisor-add" target="_parent"><img src="images/add.png" alt="add" width="100" height="30" border="0" />
        </a>  <? } ?>      </td>
    </tr>
    <?
...
if ($lock03==0)  echo "   
  ...
  ?>
    <tr>
      ...
      <td align="right" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="left" valign="top" bgcolor="#CCCCCC">
        <? if ($lock03==0) { ?>    <a href="index.php?menu=eval-g-advisor-add" target="_parent"><img src="images/add.png" alt="add" width="100" height="30" border="0" />
      </a><? } ?></td>
    </tr>
    <?
...
if ($lock03==0)  echo "   
  ...
  ?>
    ...
    <tr>
      ...
      <td align="right" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="left" valign="top" bgcolor="#CCCCCC">
        <? if ($lock03==0) { ?>    <a href="index.php?menu=eval-seminar-add" target="_parent"><img src="images/add.png" alt="add" width="100" height="30" border="0" />
...
if ($lock03==0)  echo "   
  ...
  ?>
    <tr>
      ...
      <td align="right" valign="top" bgcolor="#CCCCCC">&nbsp; </td>
      <td align="left" valign="top" bgcolor="#CCCCCC">
        <? if ($lock03==0) { ?>    <a href="index.php?menu=eval-academic-advisor-add" target="_parent"><img src="images/add.png" alt="add" width="100" height="30" border="0" />
...
if ($lock03==0)  echo "   
  ...
  ?>
    <tr>
      ...
      <td align="right" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="left" valign="top" bgcolor="#CCCCCC">
        <? if ($lock03==0) { ?>    <a href="index.php?menu=eval-activity-advisor-add" target="_parent"><img src="images/add.png" alt="add" width="100" height="30" border="0" />
...
if ($lock03==0)  echo "   
  ...
  <tr>
    <td align="left" valign="top" bgcolor="#CCCCCC">1.11)  การรายงานผลการจัดการเรียนการสอน  </td>
      ...
      <td align="right" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="left" valign="top" bgcolor="#CCCCCC">
        <? if ($lock03==0) { ?>    <a href="index.php?menu=eval-rm-add" target="_parent"><img src="images/add.png" alt="add" width="100" height="30" border="0" />
