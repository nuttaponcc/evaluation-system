...
$sql="INSERT INTO `".$tname."` VALUES(NULL,'$session_user_id','$week','$workload','$multiplier',0,'','$date_today','$year','$name')";
...
echo "<meta http-equiv=\"Refresh\" content=\"1;URL=../index.php?menu=eval\" />เพิ่มข้อมูลเข้าไปแล้ว รอสักครู่...";
