...
$year=date("Y");
	    ...
	    $query2 = "SELECT * FROM  `staffinfo`  where staffinfo.staffmajor='ภาควิชาคณิตศาสตร์' or  staffinfo.staffid='133' or  staffinfo.staffid='332'  or  staffinfo.staffid='439'  ORDER BY staffname asc ";
		$result2 = mysql_query($query2);
		
		echo "<table border=0 cellpadding=10 ><tr><td align=center>";
		echo "<strong>ตรวจสอบข้อมูลของบุคลากรภาควิชาคณิตศาสตร์</strong><br><br>";
