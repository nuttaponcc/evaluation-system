...
<div align="left">
  ...
  <form action="action-admin/del-is-advisor.php?<? echo "userid=$userid" ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
...
?>
    ...
    <tr>
      ...
      <td align="left" valign="top" bgcolor="#FFDDFF"><?
	$query = "SELECT * FROM `workload` where category=30 and id=".$row0[8];
	//echo $query;
	$result = mysql_query($query);
