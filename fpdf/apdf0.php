...
$array3[]="H";
    ...
    $sum=0;
   	$query = "SELECT * FROM `workload`,`course`,`lectures`  where lectures.courseid=course.id and lectures.workload=workload.id and  userid=$id ORDER BY date asc";
	$result = mysql_query($query);
...
$array3[]="H";
  	...
  	$query = "SELECT * FROM `workload`,`course`,`practices`  where practices.courseid=course.id and practices.workload=workload.id and  userid=$id ORDER BY date asc";
//	echo "$query";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
...
$array3[]="H";
   	...
   	$query = "SELECT * FROM `workload`,`course`,`coordinator`  where coordinator.courseid=course.id and coordinator.workload=workload.id and  userid=$id ORDER BY date asc";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
...
$array2[]="  1.4) การควบคุมการฝึกงาน/ฝึกสอน/สหกิจ";
 $array3[]="H";
   	...
   	$query = "SELECT * FROM `workload`,`internships`  where  internships.workload=workload.id and  userid=$id ORDER BY date asc";
//	echo "$query";
	//echo "$query";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
...
$array2[]="  1.5) ที่ปรึกษาโครงการปริญญานิพนธ์ ระดับปริญญาตรี";
 $array3[]="H";
   	...
   	$query = "SELECT * FROM `workload`,`undergraduate-advisor`  where  `undergraduate-advisor`.`workload`=`workload`.`id` and  `userid`=$id ORDER BY date asc";
	//echo "$query";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	 		$n=$row['score']*$row['week']*$row['multiplier'];
 ...
 $query = "SELECT * FROM `workload`,`graduate-advisor`  where  `graduate-advisor`.`workload`=`workload`.`id` and  `userid`=$id ORDER BY date asc";
	//echo "$query";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	 		$n=$row['score']*$row['week']*$row['multiplier'];
 ...
 $array3[]="H";
   	...
   	$query = "SELECT * FROM `workload`,`seminar`  where  `seminar`.`workload`=`workload`.`id` and  `userid`=$id ORDER BY date asc";
	//echo "$query";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	 		$n=$row['score']*$row['week']*$row['multiplier'];
 ...
 $array3[]="H";
   	...
   	$query = "SELECT * FROM `workload`,`academic-advisor`  where  `academic-advisor`.`workload`=`workload`.`id` and  `userid`=$id ORDER BY date asc";
	//echo "$query";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	 		$n=$row['score']*$row['week']*$row['multiplier'];
 ...
 $array3[]="H";
   	...
   	$query = "SELECT * FROM `workload`,`activity-advisor`  where  `activity-advisor`.`workload`=`workload`.`id` and  `userid`=$id ORDER BY date asc";
	//echo "$query";
 ...
 $array3[]="H";
   	...
   	$query = "SELECT * FROM `workload`,`seniorproject`  where  `seniorproject`.`workload`=`workload`.`id` and  `userid`=$id ORDER BY date asc";
 ...
 $array1[]="";
$array2[]="  1.11) การสอนเสริม (50 คน/กลุ่ม) ";
$array3[]="H";

   	$query = "SELECT * FROM `workload`,`course`,`adjunct`  where adjunct.courseid=course.id and adjunct.workload=workload.id and   userid=$id ORDER BY date asc";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	 $n=($row['t'])*$row['score']*$row['week']*$row['multiplier'];
	 $sum=$sum+$n;
 ...
 $array3[]="$n";
  ...
  $array1[]=" ";
$array2[]="  1.12) ที่ปรึกษาการค้นคว้าอิสระ ระดับปริญญาตรีและโท/เอก ";
$array3[]="H";

   	$query = "SELECT * FROM `workload`,`is-advisor`  where  `is-advisor`.`workload`=`workload`.`id` and   userid=$id ORDER BY date asc";
	//echo "$query";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	 		$n=$row['score']*$row['week']*$row['multiplier'];
...
if($r ['staffmajor'] =='คณะผู้บริหาร')$resum=($sum*100)/(180*5); else   $resum=($sum*100)/(240*5);
...
$array3[]="H";
 ...
 $sum2=0;
   	$query = "SELECT * FROM `workload`,`research1`  where  `workload`.`id` = `research1`.`workload`   and `userid`=$id ORDER BY date asc";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
...
$array3[]="H";
   	...
   	$query = "SELECT * FROM `workload`,`research3`  where  `workload`.`id` = `research3`.`workload`   and `userid`=$id ORDER BY date asc";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
...
$array3[]="H";
   	...
   	$query = "SELECT * FROM `workload`,`research_uses`  where  `workload`.`id` = `research_uses`.`workload`   and  `userid`=$id ORDER BY date asc";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	 		$n=$row['score']*$row['multiplier']*$coe[2][3];
	        $sum2=$sum2+$n;
 $array1[]="   ".$row['name'];
 $array2[]="                                                                                                                                             ( ".$row['score']."x".$row['multiplier']."x10%)";
 $array3[]="$n";
 }
...
$array3[]="H";
   	...
   	$query = "SELECT * FROM `research51`  where    `userid`=$id ORDER BY date asc";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	 		$n=$row['multiplier']*$coe[2][4]*$row['percent']/100;
	        $sum2=$sum2+$n;
 $array1[]="   ".$row['name'];
 $array2[]="                                                                                                                                               (1x".$row['multiplier']."x".$row['percent']."%x30%)";
 $array3[]="$n";
 }
...
$array3[]="H";
   	...
   	$query = "SELECT * FROM `research52`  where    `userid`=$id ORDER BY date asc";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	 		$n=$row['multiplier']*$coe[2][5]*$row['percent']/100;
	        $sum2=$sum2+$n;
 $array1[]="   ".$row['name'];
 $array2[]="                                                                                                                                               (1x".$row['multiplier']."x".$row['percent']."%x30%)";
 $array3[]="$n";
...
$array3[]="H";
   	...
   	$query = "SELECT * FROM `research53`  where    `userid`=$id ORDER BY date asc";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	 		$n=$row['multiplier']*$coe[2][6]*$row['percent']/100;
	        $sum2=$sum2+$n;
 $array1[]="   ".$row['name'];
 $array2[]="                                                                                                                                               (1x".$row['multiplier']."x".$row['percent']."%x30%)";
 $array3[]="$n";
				 ...
				 if($r['staffposition']=='รองศาสตราจารย์')  $resum=($sum2*100)/(1*5); else   $resum=($sum2*100)/(5);
   $resum=sprintf("%.2f",$resum ); 
...
$array2[]="  3.1) การบริการวิชาการในโครงการตามยุทธศาสตร์ด้านการบริการวิชาการของคณะ ( เช่น คณะกรรมในโครงการ วมว. )  / โครงการความร่วมมือกับโรงเรียนจุฬาภรณ์ / สัปดาห์วิทยาศาสตร์  ";
$array3[]="H";

 $sum3=0;
   	$query = "SELECT * FROM `workload`,`service4`  where  `service4`.`weight`=`workload`.`id` and  userid=$id ORDER BY date asc";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	 		$n=$row['score']*$row['multiplier'];
	        $sum3=$sum3+$n;
...
$array1[]="";
$array2[]="  3.2) การบริการวิชาการในระดับชาติ/นานาชาติ (เป็นคณะกรรมการในการจัดประชุมวิชาการ) ";
$array3[]="H";

   	$query = "SELECT * FROM `workload`,`service5`  where  `service5`.`weight`=`workload`.`id` and  userid=$id ORDER BY date asc";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	 		$n=$row['score']*$row['multiplier'];
	        $sum3=$sum3+$n;
...
$array1[]="";
$array2[]="  3.3) การบริการวิชาการแก่สังคมและชุมชน  ";
$array3[]="H";

   	$query = "SELECT * FROM `workload`,`service1`  where  `service1`.`weight`=`workload`.`id` and  userid=$id ORDER BY date asc";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	 		$n=$row['score']*$row['multiplier'];
	        $sum3=$sum3+$n;
...
$array1[]="";
$array2[]="  3.4) งานบริการวิชาการรับเชิญเป็นผู้ทรงคุณวุฒิ เป็นวิทยากร/ผู้ทรงคุณวุฒิอ่านผลงานวิชาการ เป็นกรรมการต่าง ๆ /ผู้ทรงคุณวุฒิอื่น ๆ อ่านผลงานอาจารย์ 3,4 / กรรมการตรวจประเมินประกันคุณภาพการศึกษา";
$array3[]="H";

   	$query = "SELECT * FROM `workload`,`service6`  where  `service6`.`weight`=`workload`.`id` and  userid=$id  ORDER BY date asc";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	 		$n=$row['score']*$row['multiplier'];
	        $sum3=$sum3+$n;
...
$array1[]="";
$array2[]="  3.5) งานบริการวิชาการรับเชิญรายบุคคล/งานบริการการสอนโรงเรียนต่าง ๆ เช่น สารคามพิทยาคม /อาจารย์ที่ปรึกษาวิทยานิพนธ์ให้กับมหาวิทยาลัยอื่น ๆ ทั้งภาครัฐและเอกชน   ";
$array3[]="H";

   	$query = "SELECT * FROM `service3`  where  userid=$id ORDER BY date asc";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
 ...
 $array1[]="";
$array2[]="  3.6) งานบริการสอนโครงการ วมว /โครงการความร่วมมือกับโรงเรียนจุฬาภรณ์ /งานตามยุทธศาสตร์ของคณะ /มหาวิทยาลัย   ";
$array3[]="H";

   	$query = "SELECT * FROM `service7`  where userid=$id ORDER BY date asc";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	 		$n=$row['amount']*$row['multiplier'];
	        $sum31=$sum31+$n;
...
$array3[]="H";
 ...
 $sum4=0;
   	$query = "SELECT * FROM `workload`,`culture`  where  `culture`.`weight`=`workload`.`id` and  userid=$id ORDER BY date asc";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	 		$n=$row['score']*$row['multiplier'];
	        $sum4=$sum4+$n;
...
$array2[]="   5.1) การบริหารจัดการหลักสูตร / ISO 17025 ";
$array3[]="H";

 $sum5=0;
     	$query = "SELECT * FROM `workload`,`other`  where  `other`.`weight`=`workload`.`id` and  `workload`.`category`=17 and   userid=$id ORDER BY date asc";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
...
$array3[]="H";
     	...
     	$query = "SELECT * FROM `workload`,`other`  where  `other`.`weight`=`workload`.`id` and  `workload`.`category`=18 and   userid=$id ORDER BY date asc";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
...
$array3[]="H";
     	...
     	$query = "SELECT * FROM `workload`,`other`  where  `other`.`weight`=`workload`.`id` and  `workload`.`category`=19 and   userid=$id ORDER BY date asc";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
...
$array1[]="";
$array2[]="   5.4) โครงการส่งเสริมวิชาการ/พัฒนานิสิต ภายในคณะ (คณะกรรมการจัดโครงการ)  ";
$array3[]="H";

     	$query = "SELECT * FROM `workload`,`other`  where  `other`.`weight`=`workload`.`id` and  `workload`.`category`=20 and   userid=$id ORDER BY date asc";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
...
$array3[]="H";
     	...
     	$query = "SELECT * FROM `workload`,`other`  where  `other`.`weight`=`workload`.`id` and  `workload`.`category`=21 and   userid=$id ORDER BY date asc";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
...
$pdf->SetXY(15,4+$h*2);
$pdf->Write(10,'ชื่อผู้รับการประเมิน   ...................................ตำแหน่ง/ระดับ ........'. $r['staffposition'].'.......... สังกัด .................คณะวิศวกรรมศาสตร์............');//'. $r['staffname'].'
$pdf->SetXY(15,4+$h*3);
$pdf->Write(10,'ชื่อผู้บังคับบัญชา/ผู้ประเมิน ..................................  ตำแหน่ง/ระดับ .......'. $r['commanderposition'].'........'); //'. $r['commander'].'
$pdf->SetXY(15,6+$h*4);
