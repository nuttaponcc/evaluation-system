...
<form id="form1" name="form1" method="post" action="http://202.28.32.130/evaluation/ac_survey02.php" enctype="application/x-www-form-urlencoded"  onsubmit="return ChkSurverData()">
  <div align="center">
    <table border="0" cellpadding="0" cellspacing="5" bgcolor="#FFFF99">
      <tbody>
        <tr>
          <td height="83" bgcolor="#FFCC00"><br />
<div align="center">	<font color=ff0000 size=5 > <strong>แบบประเมินความพึงพอใจ รอบที่ 2 ( 1  เมษายน2556 - 31 สิงหาคม 2556) </strong> </font><br />
