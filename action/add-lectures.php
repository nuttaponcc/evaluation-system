...
$sql="INSERT INTO lectures VALUES(NULL,'$session_user_id','$course','$week','$workload','$multiplier',0,'','$date_today','$year','','','')";
$result = mysql_query($sql);
//echo $sql;

$sql="select max(id) from  lectures";
$result = mysql_query($sql);
...
$filename="lectures1-".$id_max. "." .$ext;
copy($file,"../files/$filename");

$sql="update  lectures set  filename='$filename' where id='$id_max' ";
$result = mysql_query($sql);
...
$filename2="lectures2-".$id_max. "." .$ext;
copy($file,"../files/$filename2");

$sql="update  lectures set  filename2='$filename2' where id='$id_max' ";
$result = mysql_query($sql);
...
$filename3="lectures3-".$id_max. "." .$ext;
copy($file3,"../files/$filename3");

$sql="update  lectures set  filename3='$filename3' where id='$id_max' ";
$result = mysql_query($sql);
...
$filename4="lectures4-".$id_max. "." .$ext;
copy($file,"../files/$filename4");

$sql="update  lectures set  filename4='$filename4' where id='$id_max' ";
$result = mysql_query($sql);
