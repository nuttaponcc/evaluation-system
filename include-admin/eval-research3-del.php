...
<div align="left">
  ...
  <p>2. ภาระงานด้านวิจัย<br />
    2.3) บทความวิชาการ (Review paper)</p>
  <form action="action-admin/del-research3.php?<? echo "userid=$userid" ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
