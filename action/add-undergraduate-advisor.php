...
$sql="INSERT INTO internships VALUES(NULL,'$session_user_id','$week','$workload','$multiplier',0,'','$date_today','$year','$amount')";
$result = mysql_query($sql);
if(!empty($file)){
//echo $sql;
$ext=strtolower(end(explode('.', $file_name)));

$sql="select max(id) from  internships";
$result = mysql_query($sql);
$r=mysql_fetch_array($result);
$id_max=$r[0];

$filename="internships".$id_max. "." .$ext;
copy($file,"../files/$filename");

$sql="update  internships set  filename='$filename' where id='$id_max' ";
$result = mysql_query($sql);
}
