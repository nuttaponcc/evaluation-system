...
$sql="UPDATE`research2` SET `name`='$name',`multiplier`='$multiplier' ,`workload`='$workload'  WHERE  `research2`.`id`='$id' ";
//echo $sql;
$result = mysql_query($sql);

if(!empty($file)){
$ext=strtolower(end(explode('.', $file_name)));
$filename="research21-".$id. "." .$ext;
copy($file,"../files/$filename");
$sql="update  `research2` set  filename='$filename' where id='$id' ";
$result = mysql_query($sql);
}
...
$filename2="research22-".$id. "." .$ext;
copy($file2,"../files/$filename2");
$sql="update  research2 set  filename2='$filename2' where id='$id' ";
$result = mysql_query($sql);
}
...
$filename3="research23-".$id. "." .$ext;
copy($file3,"../files/$filename3");
$sql="update  research2 set  filename3='$filename3' where id='$id' ";
$result = mysql_query($sql);
}
...
$filename4="research24-".$id. "." .$ext;
copy($file4,"../files/$filename4");
$sql="update  research2 set  filename4='$filename4' where id='$id' ";
$result = mysql_query($sql);
}
...
$filename5="research25-".$id. "." .$ext;
copy($file5,"../files/$filename5");
$sql="update  research2 set  filename5='$filename5' where id='$id' ";
$result = mysql_query($sql);
}
...
$filename6="research26-".$id. "." .$ext;
copy($file6,"../files/$filename6");
$sql="update  research2 set  filename6='$filename6' where id='$id' ";
$result = mysql_query($sql);
}
