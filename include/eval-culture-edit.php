...
<div align="left"><p><strong>แก้ไข</strong>
  ...
  <form action="action/edit-culture.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table border="0" cellpadding="5" bgcolor="#FFFFFF">
    <tr>
      <td align="left" valign="top" bgcolor="#FFFF99"><input name="id" type="hidden" value="<? echo $id ?>" />
        ชื่อโครงการ</td>
      <td align="left" valign="top" bgcolor="#FFFF99"><input name="name" type="text" id="name" value="<? echo $row0['12']; ?>" size="50" /></td>
      <td align="left" valign="top" bgcolor="#FFFF99"><p>ตัวอย่างโครงการทำนุบำรุงศิลปะและวัฒนธรรม</p>
        <p>-งานส่งท้ายปีเก่าต้อนรับปีใหม่คณะวิทยาศาสตร์<br />
-งานส่งท้ายปีเก่าต้อนรับปีใหม่ภาควิชาฯ<br />
-งานทำบุณตักบาตรคณะวิทยาศาสตร์<br />
-งานทำบุณตักบาตรภาควิชาฯ<br />
-ประเพณีลอยกระทงมหาวิทยาลัยมหาสารคาม<br />
-งานคืนสู่เหย้า<br />
-งานต้อนรับบัณฑิต มหาบัณทิต ดุษฎีบัณฑิต <br />
-งานกฐินมหาวิทยาลัยมหาสารคาม<br />
-ปัจฉิมนิเทศ<br />
          </p></td>
    </tr>
    <tr>
...
?>
      ...
      <td align="left" valign="top" bgcolor="#FFFF99">
	  <!--
	  <strong>ตัวคูณ=1</strong> มีโครงการทำนุบำรุงศิลปะและวัฒนธรรม <br />
...
?>
    ...
    <tr>
      ...
      <td align="left" valign="top" bgcolor="#FFFF99"><input type="file" name="file" />
