...
<div align="left">
  <p><strong>แก้ไข</strong>
    <?php 
     	$query = "SELECT * FROM `research54`  where  `research54`.id=$id  and  userid=$userid ORDER BY date asc";
  ...
  <form action="action-admin/edit-research54.php?<? echo "userid=$userid" ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
