...
<div align="left">
  <p><strong>แก้ไข</strong><?php 
     echo 	$query = "SELECT * FROM `workload`,`is-advisor`  where  `is-advisor`.`workload`=workload.id and  `is-advisor`.id=$id  and  userid=$userid ORDER BY date asc";
  ...
  <form action="action-admin/edit-is-advisor.php?<? echo "userid=$userid" ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
