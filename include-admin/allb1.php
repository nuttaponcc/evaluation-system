...
$year=date("Y");
	    ...
	    $query2 = "SELECT * FROM  `staffinfo`  where (staffinfo.staffmajor='คณะผู้บริหาร'  or  staffinfo.staffmajor='ภาควิชาชีววิทยา'    or  staffinfo.staffmajor='ภาควิชาคณิตศาสตร์'   or  staffinfo.staffmajor='ภาควิชาเคมี'   or  staffinfo.staffmajor='ภาควิชาฟิสิกส์' )  and staffcategory = 'ข้าราชการ'and  staffinfo.staffid>0 ORDER BY  staffmajor,staffname asc ";
 ...
 if($Mrow ['b']==2)
 {
  $str ="<td align=cenetr>คะแนนดิบ<br>ด้านการสอน</td><td align=center>คะแนนดิบ<br>ด้านวิจัย(รวม)</td><td align=center>2.1</td><td align=center>2.2</td><td align=center>2.3</td><td align=center>2.4</td><td align=center>2.5</td><td align=center>2.6.1</td><td align=center>2.6.2</td><td align=center>2.6.3</td><td align=center>2.6.4</td><td align=center>คะแนนดิบ<br>ด้านการบริการ<br>วิชาการ<br>(3.1-3.4)</td><td align=center>คะแนนดิบ<br>ด้านการบริการ<br>วิชาการ<br>(3.5)</td><td align=center>คะแนนดิบ<br>ด้านทำนุบำรุงศิลปะ<br>และวัฒนธรรม</td><td align=center>คะแนนดิบด้าน<br>ช่วยการบริหาร<br>จัดการและอื่น ๆ<br>(5.1)</td><td align=center>คะแนนดิบด้าน<br>ช่วยการบริหาร<br>จัดการและอื่น ๆ<br>
(5.2-5.4)</td><td>จากระดับและค่าถ่วงน้ำหนัก </td><td>คะแนนเต็ม1 </td><td>คะแนนเต็ม 70%</td>";
  }else{
  $str="";
  }
  
  echo "<tr><td align=center>ลำดับที่</td><td align=center> ชื่อ </td><td align=center> หน่วยงาน </td>$str</tr>";
...
$p2=$p1*$percent;
 ...
 $str ="<td align=center><strong>$sum</strong></td><td align=center><strong>$sum2</strong></td><td align=center><strong>$r1</strong></td><td align=center><strong>$r2</strong></td><td align=center><strong>$r3</strong></td><td align=center><strong>$r4</strong></td><td align=center><strong>$r5</strong></td><td align=center><strong>$r61</strong></td><td align=center><strong>$r62</strong></td><td align=center><strong>$r63</strong></td><td align=center><strong>$r64</strong></td><td align=center><strong>$sum3</strong></td><td align=center><strong>$sum31</strong></td><td align=center><strong>$sum4</strong></td><td align=center><strong>$sum5</strong></td><td align=center><strong>$sum51</strong></td><td>$Tlevel</td><td>$p1</td><td>$p2</td></td>";
...
/***********จบคะแนนดิบ************/
		         ...
		         echo "<tr><td align=center>".$i++."</td><td >".$row2['staffposition']." ".$row2 ['staffname']."</td><td> ".$row2 ['staffmajor']."</td>$str 
</tr>";
		 }
		 echo"</table>";
		 echo"</td></tr></table>";
