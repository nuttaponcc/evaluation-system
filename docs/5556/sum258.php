...
<p align="center"><strong>สรุปโครงการ <br />
  ใช้ในการประเมิน วงรอบที่  รอบที่ 2 (1 มีนาคม 2558-31 สิงหาคม 2558)</strong></p>
...
if($idcode!="")
{
 	 ...
 	 $sql=" SELECT * FROM `project`  where ((`startdate`< '2015-09-30' and `startdate` > '2015-04-01' ) or  (`enddate`< '2015-09-30' and `enddate` > '2015-04-01' ) or  (`startdate`< '2015-04-01' and `enddate` > '2015-09-30' )) and `status`>0   $str_agencies  $str_subj   $str_idcode  ORDER BY `project`.`agenid` ASC";
