...
<div align="left">
  ...
  <form action="action/add-practices.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table border="0" cellpadding="5" bgcolor="#FFFFFF">
	...
	$query = "SELECT * FROM `course` where p>0  or   user2 LIKE '%".$_SESSION[session_user_id]."%'   or  code  LIKE '0299%'  or  code  LIKE '12%'   or  code  LIKE '05%'     or  code  LIKE '0203524'    or  code  LIKE '0288%' ORDER BY `course`.`code` ASC ";
