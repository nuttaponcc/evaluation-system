...
<div align="left">
  <p><strong>แก้ไข</strong>
    <?php 
     	$query = "SELECT * FROM `research52`  where  `research52`.id=$id  and  userid='".$_SESSION[session_user_id]."' ORDER BY date asc";
  ...
  <p>2. ภาระงานด้านวิจัย<br />
    2.4) ผลงานวิชาการ<br />
    2.4.2) เอกสารคำสอน </p>
  <form action="action/edit-research52.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
...
?>
      ...
      <td align="left" valign="top" bgcolor="#E9FAA3">ตัวคูณ=4 เอกสารคำสอน</td>
    </tr>
    <tr>
...
?>
    <tr>
      ...
      <td align="left" valign="top" bgcolor="#E9FAA3">- เอกสารผลงานให้เป็นไปตามประกาศ ก.พ.อ. เรื่อง หลักเกณฑ์และวิธีการพิจารณาแต่งตั้งบุคคลให้ดำรงตำแหน่ง ผศ. รศ.และ ศ. ที่ใช้ในปีปัจจุบัน <br />
