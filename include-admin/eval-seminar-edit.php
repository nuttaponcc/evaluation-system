...
<div align="left">
  <p><strong>แก้ไข</strong><?php 
     	$query = "SELECT * FROM `workload`,`seminar`  where  `seminar`.`workload`=workload.id and  `seminar`.id=$id  and  userid=$userid ORDER BY date asc";
  ...
  <form action="action-admin/edit-seminar.php?<? echo "userid=$userid" ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
...
?>
      ...
      <td align="left" valign="top" bgcolor="#FFDDFF"><div id="textweek"></div> ในกรณีเป็นคณะกรรมการสอบที่ไม่ได้เป็นอาจารย์ผู้สอนจะไม่นำจำนวนสัปดาห์ไปคิดคำนวณ</td>
    </tr>
    <tr>
