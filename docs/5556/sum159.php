...
<p align="center"><strong>สรุปโครงการ <br />
  ใช้ในการประเมิน วงรอบที่  วงรอบที่ 1 ระหว่างวันที่ 1 กันยายน 2561 - 28 กุมภาพันธ์ 2562 </strong></p>
...
if($idcode!="")
{
 	 ...
 	 $sql=" SELECT * FROM `project`  where ((`startdate`< '2016-08-31' and `startdate` > '2016-04-01' ) or  (`enddate`< '2016-08-31' and `enddate` >  '2016-04-01' ) or  (`startdate`<  '2016-04-01'  and `enddate` > '2016-08-31' )) and `status`>0   $str_agencies  $str_subj   $str_idcode  ORDER BY `project`.`agenid` ASC";
