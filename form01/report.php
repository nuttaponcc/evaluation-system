...
$staffmajor=$_POST['staffmajor'];
$staffedu=$_POST['staffedu'];
$staffcategory=$_POST['staffcategory'];
$commander=$_POST['commander'];
$commanderposition=$_POST['commanderposition'];
$date=$_POST['date'];
$ptime=$_POST['ptime'];
$acadposition=$_POST['acadposition'];
    ...
    <td><form id="form1" name="form1" method="post" action="report.php">
      ...
      <table border="0" cellspacing="1" cellpadding="1">
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td><label>
            <select name="acadposition" id="acadposition">
              <?
  if($r['acadposition']==0) echo "<option value=\"0\" selected=\"selected\">ไม่ระบุ</option>"; else echo "<option value=\"0\" >ไม่ระบุ</option>";  
  if($r['acadposition']==1) echo "<option value=\"1\" selected=\"selected\">อาจารย์</option>"; else echo "<option value=\"1\" >อาจารย์</option>";  
  if($r['acadposition']==2) echo "<option value=\"2\" selected=\"selected\">ผู้ช่วยศาสตราจารย์</option>"; else echo "<option value=\"2\" >ผู้ช่วยศาสตราจารย์</option>";  
  if($r['acadposition']==3) echo "<option value=\"3\" selected=\"selected\">รองศาสตราจารย์</option>"; else echo "<option value=\"3\" >รองศาสตราจารย์</option>";  
  if($r['acadposition']==4) echo "<option value=\"4\" selected=\"selected\">ศาสตราจารย์</option>"; else echo "<option value=\"4\" >ศาสตราจารย์</option>";  
			?>
            </select>
          </label></td>
          <td>&nbsp;</td>
        ...
        <tr>
          ...
          <td><label>
			...
			<?
  if($r['staffedu']=="ปริญญาตรี") echo "<option value=\"ปริญญาตรี\" selected=\"selected\">ปริญญาตรี</option>"; else echo "<option value=\"ปริญญาตรี\" >ปริญญาตรี</option>";  
  if($r['staffedu']=="ปริญญาโท") echo "<option value=\"ปริญญาโท\" selected=\"selected\">ปริญญาโท</option>"; else echo "<option value=\"ปริญญาโท\" >ปริญญาโท</option>";  
  if($r['staffedu']=="ปริญญาเอก") echo "<option value=\"ปริญญาเอก\" selected=\"selected\">ปริญญาเอก</option>"; else echo "<option value=\"ปริญญาเอก\" >ปริญญาเอก</option>"; 
			?>
            </select>
          </label></td>
          <td>&nbsp;</td>
