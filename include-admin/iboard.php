...
$year=date("Y");
	    ...
	    $query2 = "SELECT * FROM  `staffinfo`  where staffinfo.staffmajor='สํานักงานเลขานุการ' ORDER BY staffname asc ";
		$result2 = mysql_query($query2);
		
		echo "<table border=0 cellpadding=10 ><tr><td align=center>";
		echo "<strong>ตรวจสอบข้อมูลของบุคลากรสํานักงานเลขานุการ</strong><br><br>";
		echo "<table border=1 cellpadding=5 >";
		$i=1;
if($Mrow ['i']==2)
 {
  $str ="<td align=cenetr>คะแนนดิบ<br>ด้านการสอน</td><td align=center>คะแนนดิบ<br>ด้านวิจัย</td><td align=center>คะแนนดิบ<br>ด้านการบริการ<br>วิชาการ<br>(3.1-3.4)(3.5-3.6)</td><td align=center>คะแนนดิบ<br>ด้านทำนุบำรุงศิลปะ<br>และวัฒนธรรม</td><td align=center>คะแนนดิบด้าน<br>ช่วยการบริหาร<br>จัดการและอื่น ๆ<br>(5.1)
(5.2-5.5)</td><td> </td><td> </td><td> </td><td align=center> </td><td>30% </td><td>รวม 70%+30% </td>";
  }else{
  $str="";
  }
