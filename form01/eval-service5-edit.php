...
<div align="left"><p><strong>แก้ไข</strong>
    <?php 
     	$query = "SELECT * FROM `workload`,`service5`  where  `service5`.`weight`=workload.id and `service5`.id=$id  and  userid='".$_SESSION[session_user_id]."' ORDER BY date asc";
  ...
  <form action="action/edit-service5.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
