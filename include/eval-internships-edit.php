...
<div align="left">
  <p><strong>แก้ไข</strong>
    <?php 
     	$query = "SELECT * FROM `workload`,`internships`  where  internships.workload=workload.id and  internships.id=$id  and  userid='".$_SESSION[session_user_id]."' ORDER BY date asc";
  ...
  <form action="action/edit-internships.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
