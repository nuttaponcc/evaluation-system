...
$sql="INSERT INTO adjunct  VALUES(NULL,'$session_user_id','$course','$week','$workload','$multiplier',0,'','$date_today','$year','','','')";
$result = mysql_query($sql);
if(!empty($file)){
//echo $sql;
$ext=strtolower(end(explode('.', $file_name)));

$sql="select max(id) from  adjunct";
$result = mysql_query($sql);
$r=mysql_fetch_array($result);
$id_max=$r[0];

$filename="adjunct1-".$id_max. "." .$ext;
copy($file,"../files/$filename");

$sql="update  adjunct set  filename='$filename' where id='$id_max' ";
$result = mysql_query($sql);
}
...
$filename2="adjunct2-".$id_max. "." .$ext;
copy($file,"../files/$filename2");

$sql="update  adjunct set  filename2='$filename2' where id='$id_max' ";
$result = mysql_query($sql);
...
$filename3="adjunct3-".$id_max. "." .$ext;
copy($file3,"../files/$filename3");

$sql="update  adjunct set  filename3='$filename3' where id='$id_max' ";
$result = mysql_query($sql);
...
$filename4="adjunct4-".$id_max. "." .$ext;
copy($file,"../files/$filename4");

$sql="update  adjunct set  filename4='$filename4' where id='$id_max' ";
$result = mysql_query($sql);
