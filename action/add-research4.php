...
$sql="INSERT INTO `".$tname."` VALUES(NULL,'$session_user_id','$multiplier',0,'','$date_today','$year','$name','')";
...
$filename="research41-".$id_max. "." .$ext;
copy($file,"../files/$filename");

$sql="update  research4 set  filename='$filename' where id='$id_max' ";
$result = mysql_query($sql);
}
...
$filename2="research42-".$id_max. "." .$ext;
copy($file,"../files/$filename2");

$sql="update  research4 set  filename2='$filename2' where id='$id_max' ";
$result = mysql_query($sql);
}
