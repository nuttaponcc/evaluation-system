...
$sql="DELETE  From `service1`  WHERE `service1`.`id`='$id' ";
...
echo "<meta http-equiv=\"Refresh\" content=\"1;URL=../index.php?madmin=eval&id=$userid#3\" />ลบข้อมูลเรียบร้อยแล้ว รอสักครู่...";
