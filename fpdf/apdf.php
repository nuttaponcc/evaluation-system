 ...
 $sum2=0;
	...
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	        ...
	        $sum2=$sum2+$n;
 $array1[]="   ".$row['name'];
 $array2[]="                                                                                                                                                        ".$row['score']."x".$row['multiplier']."x".$coe[2][1]."%)";
 $array3[]="$n";
 }
...
$array3[]="H";
	...
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	        ...
	        $sum2=$sum2+$n;
 $array1[]="   ".$row['name'];
 $array2[]="                                                                                                                                                        ".$row['score']."x".$row['multiplier']."x".$coe[2][2]."%)";
 $array3[]="$n";
 }
...
$array3[]="H";
	...
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	        ...
	        $sum2=$sum2+$n;
 $array1[]="   ".$row['name'];
 $array2[]="                                                                                                                                             ( ".$row['score']."x".$row['multiplier']."x".$coe[2][3]."%)";
 $array3[]="$n";
 }
...
$array3[]="H";
	...
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	        ...
	        $sum2=$sum2+$n;
 $array1[]="   ".$row['name'];
 $array2[]="                                                                                                                                               (1x".$row['multiplier']."x".$row['percent']."%x".$coe[2][4]."%)";
 $array3[]="$n";
 }
...
$array3[]="H";
	...
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	        ...
	        $sum2=$sum2+$n;
 $array1[]="   ".$row['name'];
 $array2[]="                                                                                                                                               (1x".$row['multiplier']."x".$row['percent']."%x".$coe[2][5]."%)";
 $array3[]="$n";
 }
...
$array3[]="H";
	...
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	        ...
	        $sum2=$sum2+$n;
 $array1[]="   ".$row['name'];
 $array2[]="                                                                                                                                               (1x".$row['multiplier']."x".$row['percent']."%x".$coe[2][6]."%)";
 $array3[]="$n";
 }
...
$array3[]="H";
	...
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	        ...
	        $sum51=$sum51+$n;
 $array1[]="   ".$row['name'];
 $array2[]="                                                                                                                                                         (1x".$row['score']."x".$row['multiplier'].	"x".$coe[5][6].")";
 $array3[]="$n";
 }
