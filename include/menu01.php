  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="2" >
      <tr>
        ...
        <td align="left" bgcolor="#FFCC00"><font size="2"> <a href="index.php?menu=eval" ><strong>
        <?
        if($por==1) echo "ป.01 ข้อตกลงและแบบการประเมินผลสัมฤทธ ิ์ " ;
		 else echo "ป.03  แบบรายงานผลการปฏิบัติราชการ" ;
		?>
        </strong></a></br>
        </font> </td>
      </tr>
...
if($por==3) {					
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="2" >
        <tr>
          <td width="10" align="right" valign="top" bgcolor="<? if($menu=="eval") echo "#66FF55"; else echo "#FFFFF66"; ?>">&nbsp;</td>
          <td align="left" bgcolor="#eeccff"><font size="2"> <a href="<?=$go;?>index.php?<?=$go1;?>=eval" ><strong>ป.01 ข้อตกลงและแบบการประเมินผลสัมฤทธิ์</strong> </a></br>
          </font> </td>
        </tr>
...
<? } ?>
  ...
  <tr>
    <td>
	<?
//	if (($_SESSION[session_user_id]==482))
	{
	?>
	<Table width="100%" border="0" cellpadding="0" cellspacing="1">
      ...
      <tr>
        ...
        <td align="left" bgcolor="#E6E6E6"><font size="2">พิมพ์ ป.04 ปิดปรับปรุงชั่วคราว</font></td>
      </tr>
      <tr>
        <td align="right" valign="top" bgcolor="#FFFFFF"><img src="images/pdf.jpg" width="16" height="16" /></td>
	...
	<?
	}//else{ echo "ฟังก์ชั่นในการพิมพ์รายงานจะกลับมาใช้งานได้อีกครั้งในวันพรุ่งนี้ (23 ก.พ. 65) 10.00น. เป็นต้นไป ขออภัยในความไม่สะดวก";}
	?>	</td>
  </tr>
  <tr>
    <td>
