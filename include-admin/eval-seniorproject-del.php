...
<div align="left">
  ...
  <form action="action-admin/del-seniorproject.php?<? echo "userid=$userid" ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
...
?>
    ...
    <tr>
      ...
      <td align="left" valign="top" bgcolor="#FFDDFF"><?
	$query = "SELECT * FROM `workload` where category=15 and id=".$row0[8];
	$result = mysql_query($query);
