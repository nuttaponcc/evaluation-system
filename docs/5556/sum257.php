...
<p align="center"><strong>สรุปโครงการ <br />
  ใช้ในการประเมิน วงรอบที่  รอบที่ 2 (1 มีนาคม 2557-31 สิงหาคม 2557)</strong></p>
...
if($idcode!="")
{
 	 ...
 	 $sql=" SELECT * FROM `project`  where ((`startdate`< '2015-03-31' and `startdate` > '2014-10-01' ) or  (`enddate`< '2015-03-31' and `enddate` > '2014-10-01' ) or  (`startdate`< '2014-10-01' and `enddate` > '2015-03-31' )) and `status`>0   $str_agencies  $str_subj   $str_idcode  ORDER BY `project`.`agenid` ASC";
