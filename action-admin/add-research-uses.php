...
$sql="INSERT INTO `".$tname."`  (userid, multiplier,gold,date,year,name,workload,budget)  VALUES('$userid','$multiplier','$goal','$date_today','$year','$name','$workload','$budget')";
...
$sql="update  research_uses set  filename='$filename' where id='$id_max' ";
$result = mysql_query($sql);
}
...
$sql="update  research_uses set  filename2='$filename2' where id='$id_max' ";
$result = mysql_query($sql);
}
