...
?>		
  ...
  <table border="0" cellpadding="5" bgcolor="#FFFFFF">
    <tr>
      ...
      <td align="left" valign="top" bgcolor="#F3F2F7"><input name="name" type="text" id="name" size="120" /></td>
      <td align="left" valign="top" bgcolor="#F3F2F7">
	  <?
	       if($other==17) echo "Ex. กรรมการและเลขานุการหลักสูตรคณิตศาสตรศึกษา";
	  ?>
	  </td>
    </tr>
    <tr>
      <td align="left" valign="top" bgcolor="#F3F2F7">ภาระงาน<span class="style1">*</span> </td>
      <td align="left" valign="top" bgcolor="#F3F2F7"><?
	$query = "SELECT * FROM `workload` where category=$other  ORDER BY `workload`.`score` DESC";
	$result = mysql_query($query);
...
?>
	...
	<?  }else{  ?>
    <tr>
      <td align="left" valign="top" bgcolor="#F3F2F7">หลักฐาน (การพัฒนาและปรับปรุงหลักสูตรอย่างต่อเนื่อง ) </td>
      <td align="left" valign="top" bgcolor="#F3F2F7"><input type="file" name="file" /></td>
      <td align="left" valign="top" bgcolor="#F3F2F7">นำหลักฐานทั้งหมดบีบอัดมาเป็นไฟล์เดียว ( ชนิด ZIP หรือ RAR ) </td>
    </tr>
    <tr>
