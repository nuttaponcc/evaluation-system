...
$sql="INSERT INTO `".$tname."` VALUES(NULL,'$session_user_id','$multiplier',0,'','$date_today','$year',\"$name\",'','','','','','$workload')";
...
$filename="research31-".$id_max. "." .$ext;
copy($file,"../files/$filename");

$sql="update  research3 set  filename='$filename' where id='$id_max' ";
$result = mysql_query($sql);
}
...
$filename2="research32-".$id_max. "." .$ext;
copy($file,"../files/$filename2");

$sql="update  research3 set  filename2='$filename2' where id='$id_max' ";
$result = mysql_query($sql);
...
$filename3="research33-".$id_max. "." .$ext;
copy($file3,"../files/$filename3");

$sql="update  research3 set  filename3='$filename3' where id='$id_max' ";
$result = mysql_query($sql);
...
$filename4="research34-".$id_max. "." .$ext;
copy($file,"../files/$filename4");

$sql="update  research3 set  filename4='$filename4' where id='$id_max' ";
$result = mysql_query($sql);
...
$filename5="research35-".$id_max. "." .$ext;
copy($file5,"../files/$filename5");

$sql="update  research3 set  filename5='$filename5' where id='$id_max' ";
$result = mysql_query($sql);
...
$filename6="research36-".$id_max. "." .$ext;
copy($file,"../files/$filename6");

$sql="update  research3 set  filename6='$filename6' where id='$id_max' ";
$result = mysql_query($sql);

}

echo "<meta http-equiv=\"Refresh\" content=\"3;URL=../index.php?menu=eval2\" />เพิ่มข้อมูลเข้าไปแล้ว รอสักครู่...";
