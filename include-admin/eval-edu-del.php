...
<div align="left">
  ...
  <form action="action-admin/del-edu.php?<? echo "userid=$userid" ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table border="0" cellpadding="5" bgcolor="#FFFFFF">
    <tr>
      <td width="150" align="left" valign="top" bgcolor="#FFDDFF"><input name="id" type="hidden" value="<? echo $id ?>" />
        รหัสวิชา</td>
      <td align="left" valign="top" bgcolor="#FFDDFF"><? echo $row0['name']; ?></td>
      <td align="left" valign="top" bgcolor="#FFDDFF">&nbsp;</td>
    </tr>
    <tr>
      <td align="left" valign="top" bgcolor="#FFDDFF">ชื่อวิชา</td>
      <td align="left" valign="top" bgcolor="#FFDDFF"><? echo $row0['sname']; ?></td>
      <td align="left" valign="top" bgcolor="#FFDDFF">&nbsp;</td>
    </tr>
    <!--tr>
