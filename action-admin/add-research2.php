...
//$sql="INSERT INTO `".$tname."` VALUES('','$userid','$multiplier','$goal','','$date_today','$year','$name','','','','','','$workload')";
...
$sql="update  research2 set  filename='$filename' where id='$id_max' ";
$result = mysql_query($sql);
}
...
$sql="update  research2 set  filename2='$filename2' where id='$id_max' ";
$result = mysql_query($sql);
...
$sql="update  research2 set  filename3='$filename3' where id='$id_max' ";
$result = mysql_query($sql);
...
$sql="update  research2 set  filename4='$filename4' where id='$id_max' ";
$result = mysql_query($sql);
...
$sql="update  research2 set  filename5='$filename5' where id='$id_max' ";
$result = mysql_query($sql);
...
$sql="update  research2 set  filename6='$filename6' where id='$id_max' ";
$result = mysql_query($sql);
