...
$sql="UPDATE`research1` SET `name`='$name',`multiplier`='$multiplier',`workload`='$workload'  WHERE  `research1`.`id`='$id' ";
//echo $sql;
...
$sql="update  `research1` set  filename='$filename' where id='$id' ";
$result = mysql_query($sql);
}
...
$sql="update  research1 set  filename2='$filename2' where id='$id' ";
$result = mysql_query($sql);
}
...
$sql="update  research1 set  filename3='$filename3' where id='$id' ";
$result = mysql_query($sql);
}
...
$sql="update  research1 set  filename4='$filename4' where id='$id' ";
$result = mysql_query($sql);
}
...
$sql="update  research1 set  filename5='$filename5' where id='$id' ";
$result = mysql_query($sql);
}
...
$sql="update  research1 set  filename6='$filename6' where id='$id' ";
$result = mysql_query($sql);
}
$userid=$_GET['userid'];

echo "<meta http-equiv=\"Refresh\" content=\"1;URL=../index.php?madmin=eval&id=$userid#2\" />แก้ไขข้อมูลเข้าไปแล้ว รอสักครู่...";
