...
<div align="left">
  ...
  1.12) ที่ปรึกษาการค้นคว้าอิสระ ระดับปริญญาตรีและโท/เอก</p>
  <form action="action-admin/add-is-advisor.php?<? echo "userid=$userid" ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table border="0" cellpadding="5" bgcolor="#FFFFFF">
    <tr>
      <td align="left" valign="top" bgcolor="#FFDDFF">ชื่อ-นามสกุลนิสิตและชื่อโครงการ</td>
      <td align="left" valign="top" bgcolor="#FFDDFF"><input name="name" type="text" id="name" size="100" /></td>
	...
	$query = "SELECT * FROM `workload` where category=30 ";
