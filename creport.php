...
$year=date("Y");
	    ...
	    $query2 = "SELECT * FROM  `staffinfo`  where staffinfo.staffmajor='ภาควิชาเคมี'  or  staffinfo.staffid='423' ORDER BY staffname asc ";//or  staffinfo.staffid='133' 
		$result2 = mysql_query($query2);
		
		echo "<table border=0 cellpadding=10 ><tr><td align=center>";
		echo "<strong>ตรวจสอบข้อมูลของบุคลากรภาควิชาเคมี</strong><br><br>";
