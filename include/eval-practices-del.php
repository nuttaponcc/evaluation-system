...
<div align="left">
  ...
  <form action="action/del-practices.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
...
?></td>
    ...
    <tr>
      ...
      <td align="left" valign="top" bgcolor="#FFDDFF"><?
	$query = "SELECT * FROM `workload` where category=2 and  id=".$row0[19];
	$result = mysql_query($query);
while ($row = mysql_fetch_assoc($result)) {
