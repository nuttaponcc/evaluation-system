...
$sql="UPDATE`edu` SET `name`='$name',`sname`='$sname',`week`='$week',`workload`='$workload',`multiplier`='$multiplier' WHERE  `edu`.`id`='$id' ";
...
$sql="update  `edu` set  filename='$filename' where id='$id' ";
$result = mysql_query($sql);
}
