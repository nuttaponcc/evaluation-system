...
<div align="center"><strong><br />
  แบบรายงานผลการปฏิบัติราชการของข้าราชการและพนักงาน สังกัดมหาวิทยาลัยมหาสารคาม
  </strong>
  <br />
  <br />
  <table border="0" cellpadding="5" cellspacing="2" bgcolor="#666666">
    <tr>
      <td align="left" valign="top" bgcolor="#006699"><div align="center"><strong><font color="#FFCC00">กิจกรรม/โครงการ/งาน</font></strong></div></td>
  ...
  <tr>
	...
	if($row['filename'])
	{
	echo "(มคอ.3)<br><a href=\"files/".$row['filename']."\" target=\"_blank\">".$row['filename']."</a><br>";
	}else{
$sql2=" SELECT * FROM  `proattach`   where proid=". $row['courseid']." and  category=0";
		 $res2=mysql_query($sql2);
		 $n2=mysql_num_rows($res2);
		 if($n2>0)echo "<fieldset>  <legend>  กรณีไม่แนบไฟล์ มคอ3 ระบบจะดึงข้อมูลจากระบบ มคอ.</legend>  ";
		 while($row2=mysql_fetch_array($res2))	
		 {	 
              echo " <a   target=\"_blank\"  href=\"http://202.28.32.130/scitqf/". $row2['attlocation']."/".$row2['attfile']."\" >".$row2['attfile']."</a></br>";                 
		 }	     
         if($n2>0)echo "</fieldset>	";
	}
	
	if($row['filename2'])
	{
	echo "(มคอ.4)<br><a href=\"files/".$row['filename2']."\" target=\"_blank\">".$row['filename2']."</a><br>";
	}else{
$sql2=" SELECT * FROM  `proattach`   where proid=". $row['courseid']." and  category=4";
		 $res2=mysql_query($sql2);
		 $n2=mysql_num_rows($res2);
if($n2)echo "<fieldset>  <legend>  กรณีไม่แนบไฟล์ มคอ4 ระบบจะดึงข้อมูลจากระบบ มคอ.</legend>  ";
		 while($row2=mysql_fetch_array($res2))	
		 {	 
              echo " <a   target=\"_blank\"  href=\"http://202.28.32.130/scitqf/". $row2['attlocation']."/".$row2['attfile']."\" >".$row2['attfile']."</a></br>";                 
		 }	     
if($n2)echo "</fieldset>	";
	...
	if($row['filename3'])
	{
	echo "(ใบรายงานผลการเรียน)<br><a href=\"files/".$row['filename3']."\" target=\"_blank\">".$row['filename3']."</a><br>";
	}else{
$sql2=" SELECT * FROM  `proattach`   where proid=". $row['courseid']." and  category=2";
		 $res2=mysql_query($sql2);
		 $n2=mysql_num_rows($res2);
if($n2)echo "<fieldset>  <legend>  กรณีไม่แนบไฟล์ มคอ.5 ระบบจะดึงข้อมูลจากระบบ มคอ.</legend>  ";
		 while($row2=mysql_fetch_array($res2))	
		 {	 
              echo " <a   target=\"_blank\"  href=\"http://202.28.32.130/scitqf/". $row2['attlocation']."/".$row2['attfile']."\" >".$row2['attfile']."</a></br>";                 
		 }	     
...
if ($lock03==0) echo "
  ...
  ?>
    <tr>
      <td align="left" valign="top" bgcolor="#CCCCCC">1.8)    อาจารย์ที่ปรึกษาทางด้านวิชาการ (  IAESTE ) </td>
      <td align="center" valign="top" bgcolor="#CCCCCC"><font  size="-3">(ภาระงาน)x(สัปดาห์)x(ตัวคูณ)</font></td>
      <td align="left" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="right" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="left" valign="top" bgcolor="#CCCCCC"><a href="index.php?menu=eval-lectures-add" target="_parent"></a>
...
if ($lock03==0) echo "
  ...
  ?>
    ...
    <tr>
      <td align="left" valign="top" bgcolor="#CCCCCC">1.10) กรรมการสอบ Senior Project/วิทยานิพนธ์/คณะกรรมการสอบสัมมนา/กรรมการคุมสอบ </td>
...
if ($lock03==0)  echo "   
 <td align=\"left\" valign=\"top\" bgcolor=\"#FFFFFF\">&nbsp;</td>
  ...
  ?>
    -->
    <tr>
      <td align="left" valign="top" bgcolor="#CCCCCC">1.11) การสอนเสริม (50 คน/กลุ่ม)</td>
      <td align="center" valign="top" bgcolor="#CCCCCC"><font  size="-3">(หน่วยกิต)x(ภาระงาน)x(สัปดาห์)x(ตัวคูณ)</font></td>
      <td align="left" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="right" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="left" valign="top" bgcolor="#CCCCCC"><a href="index.php?menu=eval-adjunct-add" target="_parent">
        <? if ($lock03==0) { ?>
        <img src="images/add.png" alt="add" width="100" height="30" border="0" />
        <? } ?>
      </a></td>
    ...
    <?
   	$query = "SELECT * FROM `workload`,`course`,`adjunct`  where adjunct.courseid=course.id and adjunct.workload=workload.id and  userid='".$_SESSION[session_user_id]."' ORDER BY date asc";
	$result = mysql_query($query);
  ...
  <tr>
    <td align=\"left\" valign=\"top\" bgcolor=\"#FFFFFF\">".$row['code'].":".$row['enname']." [".$row['term']."/".$row['ayear']."]</td>
    <td align=\"left\" valign=\"top\" bgcolor=\"#FFFFFF\"><div align=\"center\">".$row['credit']."x".$row['score']."x".$row['week']."x".$row['multiplier']."=$n</div></td>
    <td align=\"left\" valign=\"top\" bgcolor=\"#FFFFFF\">";
	if($row['filename'])
	{
	echo "(มคอ.3)<br><a href=\"files/".$row['filename']."\" target=\"_blank\">".$row['filename']."</a><br>";
...
if ($lock03==0)  echo "   
    <td align=\"left\" valign=\"top\" bgcolor=\"#FFFFFF\">&nbsp;</td>
    <td align=\"left\" valign=\"top\" bgcolor=\"#FFFFFF\">
	<a href=\"index.php?menu=eval-adjunct-edit&id=".$row['id']."\" target=\"_parent\"><img src=\"images/edit.png\"  alt=\"edit\"  width=\"100\" height=\"30\" border=\"0\" /></a>
	<a href=\"index.php?menu=eval-adjunct-del&id=".$row['id']."\" target=\"_parent\"><img src=\"images/delete.png\" alt=\"delete\"  width=\"100\" height=\"30\" border=\"0\" /></a>	
	</td>
";
echo "
  </tr>	
  ...
  ?>
    <tr>
      <td align="left" valign="top" bgcolor="#CCCCCC">1.12) ที่ปรึกษาการค้นคว้าอิสระ ระดับปริญญาตรีและโท/เอก</td>
      <td align="center" valign="top" bgcolor="#CCCCCC"><font  size="-3">(ภาระงาน)x(สัปดาห์)x(ตัวคูณ)</font></td>
      <td align="left" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="right" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="left" valign="top" bgcolor="#CCCCCC"><a href="index.php?menu=eval-lectures-add" target="_parent"></a>
        <? if ($lock03==0) { ?>
      <a href="index.php?menu=eval-is-advisor-add" target="_parent"><img src="images/add.png" alt="add" width="100" height="30" border="0" /></a>
      <? } ?></td>
    </tr>
    <?
   	$query = "SELECT * FROM `workload`,`is-advisor`  where  `is-advisor`.`workload`=`workload`.`id` and  `userid`='".$_SESSION[session_user_id]."' ORDER BY date asc";
	//echo "$query";
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	 		$n=$row['score']*$row['week']*$row['multiplier'];
...
if ($lock03==0)  echo "   
    <td align=\"left\" valign=\"top\" bgcolor=\"#FFFFFF\">&nbsp;</td>
    <td align=\"left\" valign=\"top\" bgcolor=\"#FFFFFF\">
	<a href=\"index.php?menu=eval-is-advisor-edit&id=".$row['id']."\" target=\"_parent\"><img src=\"images/edit.png\"  alt=\"edit\"  width=\"100\" height=\"30\" border=\"0\" /></a>
	<a href=\"index.php?menu=eval-is-advisor-del&id=".$row['id']."\" target=\"_parent\"><img src=\"images/delete.png\" alt=\"delete\"  width=\"100\" height=\"30\" border=\"0\" /></a>	
	</td>
	";
	echo "
  </tr>	
  ...
  ?>
    ...
    <tr>
      <td align="left" valign="top" bgcolor="#CCCCCC">2.1)  งานวิจัยเพื่อสร้างองค์ความรู้ใหม่/รับใช้สังคม</td>
      <td align="center" valign="top" bgcolor="#CCCCCC"><font  size="-3">(ภาระงาน)x(ตัวคูณ)</font></td>
      <td align="left" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="right" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
...
echo "  </tr>	
  ...
  ?>
    <tr>
      <td align="left" valign="top" bgcolor="#CCCCCC">2.2) บทความวิจัยและบทความวิชาการ (Review paper)</td>
      <td align="center" valign="top" bgcolor="#CCCCCC"><font  size="-3">(ภาระงาน)x(ตัวคูณ)</font></td>
      <td align="left" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="right" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="left" valign="top" bgcolor="#CCCCCC"><? if ($lock03==0) { ?>
  ...
  ?>
    <tr>
      <td align="left" valign="top" bgcolor="#CCCCCC">2.3) งานวิจัยที่นำไปใช้ประโยชน์</td>
      <td align="center" valign="top" bgcolor="#CCCCCC"><font  size="-3">(ภาระงาน)x(ตัวคูณ)</font></td>
      <td align="left" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="right" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="left" valign="top" bgcolor="#CCCCCC"><? if ($lock03==0) { ?>
  ...
  ?>    
    <tr>
      <td align="left" valign="top" bgcolor="#CCCCCC">2.4) ผลงานวิชาการ</td>
...
$sum2; 
    ...
    <tr>
      ...
      <td align="left" valign="top" bgcolor="#A3BA1B">&nbsp;</td>
      <td align="right" valign="top" bgcolor="#A3BA1B"><? 
				 if($Mrow ['staffposition']=='รองศาสตราจารย์') $resum=($sum2*100)/(1*5); else   $resum=($sum2*100)/(1*5);
				        echo round($resum,2); 
				  ?></td>
      <td align="left" valign="top" bgcolor="#A3BA1B">&nbsp;</td>
    </tr>
    ...
    <tr>
      <td align="left" valign="top" bgcolor="#CCCCCC">3.1) การบริการวิชาการในโครงการตามยุทธศาสตร์ด้านการบริการวิชาการของคณะ
...
if ($lock03==0)  echo "   
  ...
  ?>
    <tr>
      <td align="left" valign="top" bgcolor="#CCCCCC">3.2) การบริการวิชาการในระดับชาติ/นานาชาติ (เป็นคณะกรรมการในการจัดประชุมวิชาการ)</td>
      <td align="center" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="left" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="right" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
...
if ($lock03==0)  echo "   
  ...
  ?>
    <tr>
      <td align="left" valign="top" bgcolor="#CCCCCC">3.3) โครงการบริการวิชาการแก่สังคมและชุมชน</td>
      <td align="center" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="left" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="right" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="left" valign="top" bgcolor="#CCCCCC"><? if ($lock03==0) { ?>
...
if ($lock03==0)  echo "   
  ...
  ?>
    ...
    <tr>
      <td align="left" valign="top" bgcolor="#CCCCCC">3.4)    งานบริการวิชาการรับเชิญเป็นผู้ทรงคุณวุฒิ เป็นวิทยากร/ผู้ทรงคุณวุฒิอ่านผลงานวิชาการ เป็นกรรมการต่าง ๆ /ผู้ทรงคุณวุฒิอื่น ๆ อ่านผลงานอาจารย์ 3,4 / กรรมการตรวจประเมินประกันคุณภาพการศึกษา</td>
      <td align="center" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="left" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="right" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="left" valign="top" bgcolor="#CCCCCC"><? if ($lock03==0) { ?>
...
if ($lock03==0)  echo "   
  ...
  <tr>
    <td align="left" valign="top" bgcolor="#CCCCCC">3.5) งานบริการวิชาการรับเชิญรายบุคคล/งานบริการการสอนโรงเรียนต่าง ๆ เช่น สารคามพิทยาคม /อาจารย์ที่ปรึกษาวิทยานิพนธ์ให้กับมหาวิทยาลัยอื่น ๆ ทั้งภาครัฐและเอกชน </td>
      <td align="center" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="left" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="right" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="left" valign="top" bgcolor="#CCCCCC"><? if ($lock03==0) { ?>
  ...
  <tr>
    <td align=\"left\" valign=\"top\" bgcolor=\"#FFFFFF\">".$row['name']."</td>
    <td align=\"left\" valign=\"top\" bgcolor=\"#FFFFFF\"><div align=\"center\">".$row['amount']."x1=$n</div></td>
    <td align=\"left\" valign=\"top\" bgcolor=\"#FFFFFF\"><a href=\"files/".$row['filename']."\" target=\"_blank\">".$row['filename']."</div></td>
";
if ($lock03==0)  echo "   
    <td align=\"left\" valign=\"top\" bgcolor=\"#FFFFFF\">&nbsp;</td>
  ...
  ?>
    <!--tr>
    <td align="left" valign="top" bgcolor="#B8F1F0"><font color="red">งานบริการวิชาการให้แก่หน่วยงานภายนอก<br />
      อยู่ในระหว่างการแก้ไข </font></td>
    ...
    <td align="left" valign="top" bgcolor="#B8F1F0"><? if ($lock03==9) { ?>
...
-->
    <tr>
      ...
      <td align="right" valign="top" bgcolor="#70E4E1">&nbsp;<? 
				        echo "<br>(3.5,3.6) =".round( $sum31,2);
				        echo "<br>(3.5) =".round( $sum31,2);
				  ?></td>
      <td align="left" valign="top" bgcolor="#70E4E1">&nbsp;</td>
    </tr>
    <tr>
...
echo "
  ...
  ?>
    ...
    <tr>
      <td align="left" valign="top" bgcolor="#CCCCCC">5.1) การบริหารจัดการหลักสูตร / ISO 17025 </td>
      <td align="center" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="left" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="right" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
...
if ($lock03==0)  echo "   </td>
  ...
  ?>
    ...
    <tr>
      <td align="left" valign="top" bgcolor="#CCCCCC">5.2)  การช่วยงานบริหารจัดการภาควิชา/คณะฯ</td>
      <td align="center" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="left" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="right" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
...
if ($lock03==0)  echo "   
  ...
  ?>
    ...
    <tr>
      <td align="left" valign="top" bgcolor="#CCCCCC">5.3) การพัฒนาองค์กร กรรมการหรือผู้บริหารองค์กร (ภายนอกคณะ) เช่น ผู้ช่วยอธิการบดี        รองคณบดี ผู้ช่วยคณบดีหรือตำแหน่งเทียบเท่า กรรมการภายนอกคณะ        ที่ปรึกษาภายนอกคณะ </td>
      <td align="center" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="left" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="right" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
...
if ($lock03==0)  echo "   
  ...
  ?>
    ...
    <tr>
      <td align="left" valign="top" bgcolor="#CCCCCC">5.4) โครงการส่งเสริมวิชาการ/พัฒนานิสิต ภายในคณะ </td>
      <td align="center" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="left" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="right" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
