...
$sql="UPDATE`lectures` SET `courseid`='$course',`week`='$week',`workload`='$workload',`multiplier`='$multiplier'  WHERE `lectures`.`id`='$id' ";
...
$filename="lectures1-".$id. "." .$ext;
copy($file,"../files/$filename");
$sql="update  lectures set  filename='$filename' where id='$id' ";
$result = mysql_query($sql);
}
...
$filename2="lectures2-".$id. "." .$ext;
copy($file2,"../files/$filename2");
$sql="update  lectures set  filename2='$filename2' where id='$id' ";
$result = mysql_query($sql);
}
...
$filename3="lectures3-".$id. "." .$ext;
copy($file3,"../files/$filename3");
$sql="update  lectures set  filename3='$filename3' where id='$id' ";
$result = mysql_query($sql);
}
...
$filename4="lectures4-".$id. "." .$ext;
copy($file4,"../files/$filename4");
$sql="update  lectures set  filename4='$filename4' where id='$id' ";
$result = mysql_query($sql);
}

echo "<meta http-equiv=\"Refresh\" content=\"1;URL=../index.php?madmin=eval&id=$userid#1\" />แก้ไขข้อมูลเรียบร้อยแล้ว รอสักครู่.......";
