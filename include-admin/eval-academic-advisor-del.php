...
<div align="left">
  <p><strong>ลบ</strong><?php 
     	$query = "SELECT * FROM `workload`,`academic-advisor`  where  `academic-advisor`.`workload`=workload.id and  `academic-advisor`.id=$id  and  userid=$userid ORDER BY date asc";
  ...
  <form action="action-admin/del-academic-advisor.php?<? echo "userid=$userid" ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
