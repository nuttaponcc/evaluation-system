...
$sql="UPDATE`coordinator` SET `courseid`='$course',`week`='$week',`workload`='$workload',`multiplier`='$multiplier' WHERE `coordinator`.`id`='$id' ";
...
$filename="coordinator1-".$id. "." .$ext;
copy($file,"../files/$filename");
$sql="update  coordinator set  filename='$filename' where id='$id' ";
$result = mysql_query($sql);
}
...
$filename2="coordinator2-".$id. "." .$ext;
copy($file2,"../files/$filename2");
$sql="update  coordinator set  filename2='$filename2' where id='$id' ";
$result = mysql_query($sql);
}
...
$filename3="coordinator3-".$id. "." .$ext;
copy($file3,"../files/$filename3");
$sql="update  coordinator set  filename3='$filename3' where id='$id' ";
$result = mysql_query($sql);
}
...
$filename4="coordinator4-".$id. "." .$ext;
copy($file4,"../files/$filename4");
$sql="update  coordinator set  filename4='$filename4' where id='$id' ";
$result = mysql_query($sql);
}
