...
$year=date("Y");
	    ...
	    $query2 = "SELECT * FROM  `staffinfo`  where staffinfo.staffmajor='ภาควิชาเคมี'  or  staffinfo.staffid='193'  or  staffinfo.staffid='205'   ORDER BY staffname asc ";
...
/******************** แสดงผลคะแนนดิบ  *************/
//  $str ="<td align=cenetr>$sum</td><td align=center>$sum2</td><td align=center>$sum3</td><td align=center>$sum4</td><td align=center>$sum5</td>";
