...
<div align="left">
  ...
  <form action="action-admin/del-practices.php?<? echo "userid=$userid" ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table border="0" cellpadding="5" bgcolor="#FFFFFF">
	...
	$query = "SELECT * FROM `course` where  id=".$row0['courseid'] ;
	$result = mysql_query($query);
