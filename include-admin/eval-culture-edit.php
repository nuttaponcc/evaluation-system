...
<div align="left"><p><strong>แก้ไข</strong>
    <?php 
     	$query = "SELECT * FROM `workload`,`culture`  where  `culture`.`weight`=workload.id and `culture`.id=$id  and  userid=$userid ORDER BY date asc";
  ...
  <form action="action-admin/edit-culture.php?<? echo "userid=$userid" ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table border="0" cellpadding="5" bgcolor="#FFFFFF">
    <tr>
      <td align="left" valign="top" bgcolor="#FFFF99"><input name="id" type="hidden" value="<? echo $id ?>" />
        ชื่อโครงการ</td>
      <td align="left" valign="top" bgcolor="#FFFF99"><input name="name" type="text" id="name" value="<? echo $row0['12']; ?>" size="100" /></td>
