...
<table width="100%" border="0" cellpadding="5" cellspacing="2"   id="customers02">
    ...
    <tr>
      ...
      <td align="left" valign="top" bgcolor="#E3A72B"><?  if ($lock1==0) { ?><a href="index.php?menu=eval-culture-add" target="_parent"><img src="images/add.png" alt="add"  border="0" /></a>      <? } ?>    </td>
    </tr>
    <?
...
if ($lock1==0)  echo "   
  ...
  ?>
    ...
    <tr>
      ...
      โครงการคณะวิทยาศาสตร์  <? echo $nac1?> โครงการ<br />
