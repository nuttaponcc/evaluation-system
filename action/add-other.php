...
$filename7="other7-".$id_max. "." .$ext;
copy($file7,"../files/$filename7");

$sql="update  other set  filename7='$filename7' where id='$id_max' ";
$result = mysql_query($sql);

}

echo "<meta http-equiv=\"Refresh\" content=\"1;URL=../index.php?menu=eval5\" />เพิ่มข้อมูลเข้าไปแล้ว รอสักครู่...";
