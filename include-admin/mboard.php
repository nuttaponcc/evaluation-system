...
$year=date("Y");
	    ...
	    $query2 = "SELECT * FROM  `staffinfo`  where staffinfo.staffmajor='ภาควิชาคณิตศาสตร์' or  staffinfo.staffid='133' or  staffinfo.staffid='595'   ORDER BY staffname asc ";
	    $query2 = "SELECT * FROM  `staffinfo` where  1  ORDER BY staffname asc ";
