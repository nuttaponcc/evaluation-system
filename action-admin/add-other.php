...
$sql="INSERT INTO `".$tname."` VALUES(NULL,'$userid','$multiplier','0','','$date_today','$year','$name','$weight','','','','','','')";
...
$filename2="other2-".$id_max. "." .$ext;
copy($file,"../files/$filename2");

$sql="update  other set  filename2='$filename2' where id='$id_max' ";
$result = mysql_query($sql);
...
$filename3="other3-".$id_max. "." .$ext;
copy($file3,"../files/$filename3");

$sql="update  other set  filename3='$filename3' where id='$id_max' ";
$result = mysql_query($sql);
...
$filename4="other4-".$id_max. "." .$ext;
copy($file,"../files/$filename4");

$sql="update  other set  filename4='$filename4' where id='$id_max' ";
$result = mysql_query($sql);
...
$filename5="other5-".$id_max. "." .$ext;
copy($file5,"../files/$filename5");

$sql="update  other set  filename5='$filename5' where id='$id_max' ";
$result = mysql_query($sql);
...
$filename6="other6-".$id_max. "." .$ext;
copy($file,"../files/$filename6");

$sql="update  other set  filename6='$filename6' where id='$id_max' ";
$result = mysql_query($sql);
