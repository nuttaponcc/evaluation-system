...
$yy=$pdf->GetY();
	...
	$s=$r2['method'];
	$pdf->SetXY(110,$y);
	$pdf->MultiCell( 48 , 5 , $s);        
if($yy<$pdf->GetY())$yy=$pdf->GetY();
	$s=$r2['ptime'];
	$pdf->SetXY(160,$y);
	$pdf->MultiCell( 38 , 5 , $s );        
if($yy<$pdf->GetY())$yy=$pdf->GetY();
	$x1=0;
$pdf->Line($x1+10,$yy, $x2-10, $yy);
...
$pdf->Line($x1+10,$y, $x1+10, $yy);
$pdf->Line(110,$y, 110, $yy);
$pdf->Line(160,$y, 160, $yy);
$pdf->Line($x2-10,$y, $x2-10, $yy);
$i++;
$y=$yy;
if($y>220) 
{
