...
$sql="DELETE  From `research_uses`  WHERE `research_uses`.`id`='$id' ";
...
//echo $sql;
echo "<meta http-equiv=\"Refresh\" content=\"1;URL=../index.php?menu=eval2\" />ลบข้อมูลเรียบร้อยแล้ว รอสักครู่...";
?>