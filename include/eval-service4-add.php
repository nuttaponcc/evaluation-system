...
<div align="left">
  ...
  <p>3. ภาระงานด้านการบริการวิชาการ <br />
    3.1) การบริการวิชาการในโครงการตามยุทธศาสตร์ด้านการบริการวิชาการของคณะ <br />
เช่น กรรมการสัปดาห์วันวิทยาศาสตร์, การบริการแก่สังคมและชุมชน</p>
  <form action="action/add-service4.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table border="0" cellpadding="5" bgcolor="#FFFFFF">
    <tr>
      ...
      <td align="left" valign="top" bgcolor="#BBFFFF">โครงการอยู่ในขอบข่ายตามของ 3.1 เช่น โครงการสัปดาห์วันวิทยาศาสตร์ ใช้ตัวคูณ=5 </td>
    </tr>
    <tr>
...
while ($row = mysql_fetch_assoc($result)) {
    ...
    <tr>
      ...
      <td align="left" valign="top" bgcolor="#BBFFFF">
<select name="multiplier" id="multiplier" onchange="javascript:changediv(this.value,this.name);">
