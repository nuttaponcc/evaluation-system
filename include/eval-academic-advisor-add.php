...
<div align="left">
  ...
  <form action="action/add-academic-advisor.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table border="0" cellpadding="5" bgcolor="#FFFFFF">
    <tr>
      <td align="left" valign="top" bgcolor="#FFDDFF">ชื่อ</td>
    ...
    <tr>
      ...
      <td align="left" valign="top" bgcolor="#FFDDFF"><span class="style2">ตัวคูณ=1 มีการจัดการบริการให้คำปรึกษาทางวิชาการ และแนะแนวทางการใช้ชีวิตที่ถูกต้องแก่นิสิต <br />
        ...
        ตัวคูณ=4 มีการประเมินผลคุณภาพของการให้บริการให้ คำปรึกษาการบริการข้อมูลและนำผลการประเมินมา ปรับปรุงคุณภาพการให้บริการ  <br />
         ตัวคูณ=5ได้รับรางวัลหรือเผยแพร่ระดับชาติ/นานาชาติ
		</span></td>
    </tr>
    <!--tr>
