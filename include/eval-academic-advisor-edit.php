...
<div align="left">
  ...
  <form action="action/edit-academic-advisor.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
...
ตัวคูณ=5ได้รับรางวัลหรือเผยแพร่ระดับชาติ/นานาชาติ</span></td>
    </tr>
    <!--tr>
