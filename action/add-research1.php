...
$sql="INSERT INTO `".$tname."`  (userid, multiplier,gold,date,year,name,workload,budget)  VALUES('$session_user_id','$multiplier',0,'$date_today','$year','$name','$workload',0)";
...
echo "<meta http-equiv=\"Refresh\" content=\"2;URL=../index.php?menu=eval2\" />เพิ่มข้อมูลเข้าไปแล้ว รอสักครู่...";
