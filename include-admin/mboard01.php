...
//		echo "<strong><a href=\"http://202.28.32.130/ohm/คะแนนM.xlsx\">ดาวน์โหลดข้อมูลไฟล์ Excel </a></strong><br><br>";	
		echo "<table border=1 cellpadding=5 >";
		$i=1;
 if($Mrow ['m']==2)
 {
  $str ="<td align=cenetr>ด้านการสอน</td><td align=center>ด้านวิจัย</td><td align=center>ด้านการบริการวิชาการ</td><td align=center>ด้านทำนุบำรุงศิลปะและวัฒนธรรม</td><td align=center>ด้านช่วยการบริหารจัดการและอื่น ๆ</td><td> รวม(ระดับXค่าถ่วงน้ำหนัก)</td><td>คะแนนเต็ม1</td><td>คะแนนเต็ม70%</td>";
  }else{
  $str="";
  }
...
if($percent==70)  
{
 ...
 $str ="<td align=center>$grade1</td><td align=center>$grade2</td><td align=center>$grade3</td><td align=center>$grade4</td><td align=center>$grade5</td><td>$Tlevel</td><td>$p1</td><td>$p2</td>";
...
/***********จบคะแนนดิบ************/
		         ...
		         echo "<tr><td align=center>".$i++."</td><td >".$row2 ['staffname']."</td>$str 
</tr>";
		 }
		 echo"</table>";
		 echo"</td></tr></table>";
