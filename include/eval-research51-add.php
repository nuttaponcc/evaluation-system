...
<div align="left">
  ...
  <p>2. ภาระงานด้านวิจัย<br />
    2.4) ผลงานวิชาการ<br />
    2.4.1) เอกสารประกอบการสอน	
  </p>
  <form action="action/add-research51.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table border="0" cellpadding="5" bgcolor="#FFFFFF">
    <tr>
      <td align="left" valign="top" bgcolor="#E9FAA3"><p>ชื่อ</p>        </td>
