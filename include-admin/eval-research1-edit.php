...
<div align="left">
  <p><strong>แก้ไข</strong>
    <?php 
     	$query = "SELECT * FROM `research1`  where  `research1`.id=$id  and  userid=$userid ORDER BY date asc";
  ...
  <form action="action-admin/edit-research1.php?<? echo "userid=$userid" ?> " method="post" enctype="multipart/form-data" name="form1" id="form1">
...
?>
      ...
      <td align="left" valign="top" bgcolor="#E9FAA3"><span class="style2"><strong>จำนวนงบประมาณสนับสนุนโครงการวิจัย
...
ตัวคูณ=0 ไม่มีเงินทุน </span></td>
    </tr>
    <tr>
      <td align="left" valign="top" bgcolor="#E9FAA3"><strong>หลักฐาน </strong><br />
        -ประกาศทุน หรือ สัญญารับทุน
    <!-- (งานวิจัยที่ได้รับทุนวิจัยภายในคณะหรือภายในมหาวิทยาลัย)  -->
      </td>
    ...
    <tr>
      <td align="left" valign="top" bgcolor="#E9FAA3">หลักฐาน (ผลงานวิจัยตีพิมพ์เผยแพร่ในฐานข้อมูล Scopus  หรือบทความวิชาการที่ได้รับเผยแพร่ระดับชาติหรือระดับนานาชาติ หรือ ผลงานวิจัยถูกนำไปใช้ประโยชน์โดยมีหนังสือรับรองจากผู้นำไปใช้ประโยชน์หรือหน่วยงานภายนอกหรือชุมชน) </td>
    ...
    <tr>
      <td align="left" valign="top" bgcolor="#E9FAA3">หลักฐาน (มีผลงานวิจัยตีพิมพ์เผยแพร่ในวารสารที่มีชื่อปรากฏอยู่ในฐานข้อมูล ISI) </td>
