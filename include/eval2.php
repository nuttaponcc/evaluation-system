...
<table width="100%" border="0" cellpadding="5" cellspacing="2"   id="customers02">
    ...
    <tr>
      ...
      <td align="center" valign="top" bgcolor="#CCCCCC"><font  size="-3">(ภาระงาน)x(ตัวคูณ)x
        <?=($coe[2][1]*100).'%'?>
      </font></td>
  ...
  <tr>
    ...
    <td align=\"left\" valign=\"top\"><div align=\"center\">".$row['score']."x".$row['multiplier']."x$coe[2][1]=$n</div></td>
...
if ($lock03==0) 	echo "</td>    <td align=\"left\" valign=\"top\">&nbsp;</td>
    <td align=\"left\" valign=\"top\">
...
echo "  </tr>	
  ...
  <tr>
    <td align=\"left\" valign=\"top\">".$row['name']."  </td>
    <td align=\"left\" valign=\"top\"><div align=\"center\">".$row['score']."x".$row['multiplier']."x$coe[2][2]=$n</div></td>
   <td align=\"left\" valign=\"top\">";
	if($row['filename'])echo "<a href=\"files/".$row['filename']."\" target=\"_blank\">".$row['filename']."</a><br>";
	if($row['filename2'])echo "<a href=\"files/".$row['filename2']."\" target=\"_blank\">".$row['filename2']."</a><br>";
	if($row['filename3'])echo "<a href=\"files/".$row['filename3']."\" target=\"_blank\">".$row['filename3']."</a><br>";
  ...
  <tr>
    <td align=\"left\" valign=\"top\">".$row['name']."  </td>
    <td align=\"left\" valign=\"top\"><div align=\"center\">".$row['score']."x".$row['multiplier']."x$coe[2][3]=$n</div></td>
   <td align=\"left\" valign=\"top\">";
	if($row['filename'])echo "<a href=\"files/".$row['filename']."\" target=\"_blank\">".$row['filename']."</a><br>";
	if($row['filename2'])echo "<a href=\"files/".$row['filename2']."\" target=\"_blank\">".$row['filename2']."</a><br>";
	if ($lock03==0) echo "</td>    <td align=\"left\" valign=\"top\">&nbsp;</td>
  ...
  ?>    
    ...
    <tr>
      ...
      <td align="center" valign="top" bgcolor="#CCCCCC"><font  size="-3">(ภาระงาน)x(ตัวคูณ)x(เปอร์เซ็นต์การทำ)x
          <?=($coe[2][4]*100).'%'?>
      </font></td>
      <td align="left" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="right" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
  ...
  ?>
    ...
    <!--tr>
      ...
      <td align="left" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="right" valign="top" bgcolor="#CCCCCC">&nbsp;</td>
      <td align="left" valign="top" bgcolor="#CCCCCC"><? if ($lock03==0) { ?>      <a href="index.php?menu=eval-research54-add" target="_parent"><img src="images/add.png" alt="add" width="100" height="30" border="0" /></a><? } ?></td>
    </tr-->
    <?
