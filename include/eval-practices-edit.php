...
<div align="left">
  ...
  <?php 
     	...
     	$query = "SELECT * FROM `workload`,`course`,`practices`  where practices.courseid=course.id and practices.workload=workload.id and practices.id=$id and  userid='".$_SESSION[session_user_id]."' ORDER BY date asc";
  ...
  <form action="action/edit-practices.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table border="0" cellpadding="5" bgcolor="#FFFFFF">
	...
	$query = "SELECT * FROM `course` where p>0  or  code  LIKE '0299%'  or  code  LIKE '12%'   or  code  LIKE '05%'    or  code  LIKE '0203524'    or  code  LIKE '0288%'  ORDER BY `course`.`code` ASC ";
// 	$query = "SELECT * FROM `course`  where p>0  and   user2 like '%".$_SESSION[session_user_id]."%'   ORDER BY `course`.`code` ASC ";
...
?>
      ...
      <td align="left" valign="top" bgcolor="#FFDDFF"><font color="#0000FF">ตัวคูณ=3 มีรายละเอียดของรายวิชา (มคอ.3) และ รายละเอียดของประสบการณ์ (ถ้ามี) (มคอ.4) <br />
