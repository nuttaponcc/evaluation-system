...
<div align="left"><p><strong>แก้ไข</strong>
    <?php 
     	$query = "SELECT * FROM `workload`,`service2`  where  `service2`.`weight`=workload.id and `service2`.id=$id  and  userid='".$_SESSION[session_user_id]."' ORDER BY date asc";
		$result = mysql_query($query);
		$row0 = mysql_fetch_row($result);
  ?>
</p>
  <p>3. ภาระงานด้านการบริการวิชาการ <br />
  3.4) งานบริการวิชาการให้แก่หน่วยงานภายนอก</p>
  <form action="action/edit-service2.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
