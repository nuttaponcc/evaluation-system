...
$year=date("Y");
	    ...
	    $query2 = "SELECT * FROM  `staffinfo`  where staffinfo.staffmajor='ภาควิชาชีววิทยา'   or  staffinfo.staffid='254' or  staffinfo.staffid='228' or  staffinfo.staffid='373' or  staffinfo.staffid='240' ORDER BY staffname asc ";
