...
<div align="left">
  ...
  <p>2. ภาระงานด้านวิจัย<br />
    2.4) ผลงานวิชาการ<br />
  <strong>ตำราหรือหนังสือหรือหนังสือแปล/book chapter</strong></p>
  <form action="action/add-research53.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table border="0" cellpadding="5" bgcolor="#FFFFFF">
    <tr>
      <td align="left" valign="top" bgcolor="#E9FAA3">ชื่อ</td>
    ...
    <tr>
      <td align="left" valign="top" bgcolor="#E9FAA3">อัตราส่วนในการมีส่วนร่วมทำ<span class="style1">*</span></td>
...
?>
    <tr>
      ...
      <td align="left" valign="top" bgcolor="#E9FAA3"> - หนังสือให้เป็นไปตามประกาศ ก.พ.อ. เรื่อง หลักเกณฑ์และวิธีการพิจารณาแต่งตั้งบุคคลให้ดำรงตำแหน่งผศ. รศ.และ ศ. ที่ใช้ในปีปัจจุบัน<br />
        **
    ...
    <tr>
      ...
      <td align="left" valign="top" bgcolor="#E9FAA3">- หนังสือหรือตำราที่จัดพิมพ์โดยสำนักพิมพ์ที่ได้รับการยอมรับ พร้อมแสดงหลักฐานการมีส่วนร่วม <br />
        **นำหลักฐานทั้งหมดบีบอัดมาเป็นไฟล์เดียว ( ชนิด ZIP หรือ RAR ) </td>
    </tr>
 <?
if ($lock_att==1) echo "-->";
?>
    ...
    <p class="style1">- ตำราหรือหนังสือหรือหนังสือแปล/book chapter	 (		 (ที่เกี่ยวข้องการยื่นขอกำหนดตำแหน่งทางวิชาการ) คิด <strong>5 รอบการประเมิน</strong><br />
  - ตำราหรือหนังสือหรือหนังสือแปล		 (ที่ไม่เกี่ยวข้องการยื่นขอกำหนดตำแหน่งทางวิชาการและต้องจัดพิมพ์โดยสำนักพิมพ์) คิด<strong> 3 รอบการประเมิน</strong><br />
<br />
<br />
    * ใช้ในการคำนวน    </p>
    <p>
