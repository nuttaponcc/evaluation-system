...
<div align="left"><p><strong>แก้ไข</strong>
    <?php 
     	$query = "SELECT * FROM `workload`,`service1`  where  `service1`.`weight`=workload.id and `service1`.id=$id  and  userid='".$_SESSION[session_user_id]."' ORDER BY date asc";
  ...
  <p>3. ภาระงานด้านการบริการวิชาการ <br />
    3.3) การบริการวิชาการที่สร้างรายได้ให้กับคณะวิทยาศาสตร์ <br />
เช่น gifted, การอบรมหลักสูตรระยะสั้น การจัดทำหลักสูตร credit bank<br />
เป็นต้น</p>
  <form action="action/edit-service1.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
