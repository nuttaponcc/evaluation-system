...
$sql="INSERT INTO `".$tname."` VALUES(NULL,'$session_user_id','$multiplier','$amount','','$date_today','$year','$name',0)";
...
echo "<meta http-equiv=\"Refresh\" content=\"1;URL=../index.php?menu=eval3\" />เพิ่มข้อมูลเข้าไปแล้ว รอสักครู่...";
