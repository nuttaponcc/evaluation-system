  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="2" >
      <tr>
        ...
        <td align="left" bgcolor="#FFFF66"><font size="2"> <a href="index.php?menu=weight" ><strong>ค่าน้ำหนัก</strong> </a></br>
        </font> </td>
      </tr>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="2" >
      <tr>
        ...
        <td align="left" bgcolor="#FFFF66"><font size="2"> <a href="index.php?menu=eval" ><strong>ป.01 ข้อตกลงและแบบการประเมินผลสัมฤทธิ์</strong> </a></br>
        </font> </td>
      </tr>
      <tr>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="2" >
      <tr>
        ...
        <td align="left" bgcolor="#FFFF66"><font size="2"> <a href="index.php?menu=eval6" ><strong>พฤติกรรมการปฏิบัติราชการ 	</strong> </a></br>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="2" >
        <tr>
          ...
          <td align="left" bgcolor="#FFFF66"><font size="2"> <a href="index.php?menu=eval-dev" ><strong>แบบฟอร์มแผนพัฒนารายบุคคล</strong> </a></br>
          </font> </td>
        </tr>
    </table></td>
  </tr>
...
<?  if($Mrow ['m']){  ?>		
        <tr>
          ...
          <td align="left" bgcolor="#FFCC66"><font size="2"> <a href="index.php?menu=mboard" ><strong>ภาควิชาคณิตศาสตร์  </strong> </a></br>
          </font></td>
        </tr>
<? }  if($Mrow ['p']){  ?>		
        <tr>
          <td width="10" align="right" valign="top" bgcolor="<? if($menu=="chk") echo "#66FF55"; else echo "#FFFFF66"; ?>">&nbsp;</td>
          <td align="left" bgcolor="#FFCC66"><font size="2"> <a href="index.php?menu=pboard" ><strong>ภาควิชาฟิสิกส์ </strong> </a></br>
          </font></td>
        </tr>
<? }  if($Mrow ['b']){  ?>		
        <tr>
          <td width="10" align="right" valign="top" bgcolor="<? if($menu=="chk") echo "#66FF55"; else echo "#FFFFF66"; ?>">&nbsp;</td>
          <td align="left" bgcolor="#FFCC66"><font size="2"> <a href="index.php?menu=bboard" ><strong>ภาควิชาชีววิทยา </strong> </a></br>
          </font></td>
        </tr>
<? }  if($Mrow ['c']){  ?>		
        <tr>
          <td width="10" align="right" valign="top" bgcolor="<? if($menu=="chk") echo "#66FF55"; else echo "#FFFFF66"; ?>">&nbsp;</td>
          <td align="left" bgcolor="#FFCC66"><font size="2"> <a href="index.php?menu=cboard" ><strong>ภาควิชาเคมี </strong> </a></br>
          </font></td>
        </tr>
        <tr>
          <td align="right" valign="top" bgcolor="<? if($menu=="chk") echo "#66FF55"; else echo "#FFFFF66"; ?>">&nbsp;</td>
          <td align="left" bgcolor="#FFCC66"><font size="2"> <a href="index.php?menu=iboard" ><strong>สํานักงานเลขานุการ</strong> </a></br>
          </font></td>
        </tr>
<? }  if($Mrow ['a']){  ?>		
        <tr>
          <td width="10" align="right" valign="top" bgcolor="<? if($menu=="chk") echo "#66FF55"; else echo "#FFFFF66"; ?>">&nbsp;</td>
          <td align="left" bgcolor="#FFCC66"><font size="2"> <a href="index.php?menu=aboard" ><strong>คณะผู้บริหาร</strong> </a></br>
          </font></td>
        </tr>
<? }   ?>		
      </table>
