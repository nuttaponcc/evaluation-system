...
<table border="0" cellpadding="5" cellspacing="2" bgcolor="#666666">
  ...
  <tr>
    ...
    <td align="left" valign="top" bgcolor="#FFCCCC"><? if ($lock1==0) { ?><a href="index.php?menu=eval-lectures-add" target="_parent"><img src="images/add.png" alt="add" width="100" height="30" border="0" /></a><? } ?></td>
  </tr>
  <?
    $sum=0;
...
echo "
  ...
  <tr>
    ...
    <td align="left" valign="top" bgcolor="#C8E234"><? if ($lock1==0) { ?>
...
if ($lock1==0) 	echo "</td>    <td align=\"left\" valign=\"top\" bgcolor=\"#E8FFE8\">&nbsp;</td>
    <td align=\"left\" valign=\"top\" bgcolor=\"#E8FFE8\">
...
echo "  </tr>	
 ...
 <tr>
  ...
  <tr>
    ...
    <td align="left" valign="top" bgcolor="#BAE94B"><? if ($lock1==0) { ?>
...
$sum2; 
 ...
 <tr>
    ...
    <td align="left" valign="top" bgcolor="#B8F1F0"><? if ($lock1==0) { ?>
...
if ($lock1==0)  echo "   
  ...
  <tr>
    ...
    <td align="left" valign="top" bgcolor="#B8F1F0">&nbsp;</td>
    <td align="right" valign="top" bgcolor="#B8F1F0">&nbsp;</td>
    <td align="left" valign="top" bgcolor="#B8F1F0"><? if ($lock1==0) { ?><a href="index.php?menu=eval-service5-add" target="_parent"><img src="images/add.png" alt="add"  border="0" />
...
if ($lock1==0)  echo "   
  ...
  <tr>
    ...
    <td align="left" valign="top" bgcolor="#FFDB4A"><? if ($lock1==0) { ?>
