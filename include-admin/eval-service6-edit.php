...
<div align="left"><p><strong>แก้ไข</strong>
  ...
  <form action="action-admin/edit-service6.php?<? echo "userid=$userid" ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
...
?>
        ...
        <td align="left" valign="top" bgcolor="#BBFFFF">        ตัวคูณ=5 </td>
      </tr>
      <tr>
