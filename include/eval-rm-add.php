...
<div align="left">
  ...
  <form action="action/add-rm.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
...
//	$query = "SELECT * FROM `course2`  where t>=0 $cond or  code  LIKE '0299%'  ";
			$query = "SELECT * FROM `course2`  where  user1 like '%".$_SESSION[session_user_id]."%'  or    user2 like '%".$_SESSION[session_user_id]."%'   ORDER BY `course`.`code` ASC ";
