...
$sql="UPDATE`internships` SET `name`='$name',`week`='$week',`workload`='$workload',`multiplier`='$multiplier' WHERE `internships`.`id`='$id' ";
//echo $sql;
...
$filename="internships".$id. "." .$ext;
copy($file,"../files/$filename");

$sql="update  internships set  filename='$filename' where id='$id' ";
$result = mysql_query($sql);
}
