...
<div align="left">
  <p><strong>แก้ไข</strong>
    <?php 
     	$query = "SELECT * FROM `research_uses`  where  `research_uses`.id=$id  and  userid='".$_SESSION[session_user_id]."' ORDER BY date asc";
		$result = mysql_query($query);
		$row0 = mysql_fetch_array($result);
  ?>
  </p>
  <p>2. ภาระงานด้านวิจัย<br />
    2.3) งานวิจัยที่นำไปสร้างมูลค่าเพิ่ม  </p>
  <form action="action/edit-research-uses.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
...
?>
    <tr>
      <td align="left" valign="top" bgcolor="#E9FAA3">หลักฐาน (<strong>มีผลงานวิจัยที่นำไปใช้ประโยชน์ในเชิงวิชาการ</strong>) </td>
      <td align="left" valign="top" bgcolor="#E9FAA3"><input type="file" name="file" />
          <? echo "<a href=\"files/".$row0['filename']."\" >".$row0['filename']."</a> " ?></td>
      <td align="left" valign="top" bgcolor="#E9FAA3"><p>- หนังสือขอบคุณจากหน่วยงานภายนอกมหาวิทยาลัย พร้อม  นวัตกรรม <br />
        - หนังสือรับรองการนำงานวิจัยไปใช้ประโยชน์ จากหน่วยงาน ภายนอกมหาวิทยาลัย </p>
        <p>นำหลักฐานทั้งหมดบีบอัดมาเป็นไฟล์เดียว ( ชนิด ZIP หรือ RAR ) </p></td>
      </tr>
    <tr>
      <td align="left" valign="top" bgcolor="#E9FAA3">หลักฐาน (<strong>มีผลงานวิจัยที่นำไปใช้ประโยชน์ในเชิงสาธารณะ/นโยบาย/พาณิชย์นับซ้ำได้ ไม่ซ้ำหน่วยงาน</strong> ) </td>
      ...
      <td align="left" valign="top" bgcolor="#E9FAA3"> มีผลงานนวัตกรรมที่สามารถ  สร้างมูลค่าเพิ่มให้กับคณะวิทยาศาสตร์<br />
