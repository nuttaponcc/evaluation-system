...
$query = "SELECT * FROM `behavior` where   userid  = '$id ' ";
...
$r = mysql_fetch_assoc($result);
				...
				$weight4=$row['w4'];
				$weight5=$row['w5'];
				if($row['status']>0)$percent=50; else $percent=70;
...
$array1[]="";
$array2[]="  2.2) บทความวิจัยและบทความวิชาการ ";
$array3[]="H";
 $array4[]="";
...
$array3[]="H";
 $array4[]="";
	...
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	 		$n=$row['score']*$coe[2][3]*$row['multiplier'];
	        $sum2=$sum2+$n;
 $array1[]="   ".$row['name'];
 $array2[]="                                                                                                                                                         (1x".$row['multiplier'].	"x10%)";
 $array3[]="$n";
 ...
 $array4[]="";
	...
	$result = mysql_query($query);
     while ($row = mysql_fetch_assoc($result)) {
	        ...
	        $sum2=$sum2+$n;
 $array1[]="   ".$row['name'];
 $array2[]="                                                                                                                                               (1x".$row['multiplier']."x".$row['percent']."%".$coe[2][5]."%)";
 $array3[]="$n";
...
$array1[]="";
$array2[]="  3.2) งานบริการวิชาการรับเชิญเป็นผู้ทรงคุณวุฒิเป็นวิทยากร/ผู้ทรงคุณวุฒิอ่านผลงานวิชาการ /กรรมการสอบวิทยานิพนธ์ เป็นกรรมการต่าง ๆ /ผู้ทรงคุณวุฒิอื่น ๆ  ";
$array3[]="H";
$array4[]="";
