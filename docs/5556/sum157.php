...
<p align="center"><strong>สรุปโครงการ <br />
  ใช้ในการประเมิน วงรอบที่ 1 (1 ตุลาคม พ.ศ. 2556 ถึง 31 มีนาคม พ.ศ. 2557)</strong></p>
...
if($idcode!="")
{
 	 ...
 	 $sql=" SELECT * FROM `project`  where ((`startdate`< '2014-03-31' and `startdate` > '2013-10-01' ) or  (`enddate`< '2014-03-31' and `enddate` > '2013-10-01' ) or  (`startdate`< '2013-10-01' and `enddate` > '2014-03-31' )) and `status`>0   $str_agencies  $str_subj   $str_idcode  ORDER BY `project`.`agenid` ASC";
