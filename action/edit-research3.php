...
$sql="UPDATE`research3` SET `name`='$name',`multiplier`='$multiplier' ,`workload`='$workload'   WHERE  `research3`.`id`='$id' ";
//echo $sql;
...
$filename="research31-".$id. "." .$ext;
copy($file,"../files/$filename");
$sql="update  `research3` set  filename='$filename' where id='$id' ";
$result = mysql_query($sql);
}
...
$filename2="research32-".$id. "." .$ext;
copy($file2,"../files/$filename2");
$sql="update  research3 set  filename2='$filename2' where id='$id' ";
$result = mysql_query($sql);
}
...
$filename3="research33-".$id. "." .$ext;
copy($file3,"../files/$filename3");
$sql="update  research3 set  filename3='$filename3' where id='$id' ";
$result = mysql_query($sql);
}
...
$filename4="research34-".$id. "." .$ext;
copy($file4,"../files/$filename4");
$sql="update  research3 set  filename4='$filename4' where id='$id' ";
$result = mysql_query($sql);
}
...
$filename5="research35-".$id. "." .$ext;
copy($file5,"../files/$filename5");
$sql="update  research3 set  filename5='$filename5' where id='$id' ";
$result = mysql_query($sql);
}
...
$filename6="research36-".$id. "." .$ext;
copy($file6,"../files/$filename6");
$sql="update  research3 set  filename6='$filename6' where id='$id' ";
$result = mysql_query($sql);
}
