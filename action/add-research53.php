...
$filename="research531-".$id_max. "." .$ext;
copy($file,"../files/$filename");

$sql="update  research53 set  filename='$filename' where id='$id_max' ";
$result = mysql_query($sql);
}
...
$filename2="research532-".$id_max. "." .$ext;
copy($file,"../files/$filename2");

$sql="update  research53 set  filename2='$filename2' where id='$id_max' ";
$result = mysql_query($sql);
...
$filename3="research533-".$id_max. "." .$ext;
copy($file3,"../files/$filename3");

$sql="update  research53 set  filename3='$filename3' where id='$id_max' ";
$result = mysql_query($sql);
...
$filename4="research534-".$id_max. "." .$ext;
copy($file,"../files/$filename4");

$sql="update  research53 set  filename4='$filename4' where id='$id_max' ";
$result = mysql_query($sql);
