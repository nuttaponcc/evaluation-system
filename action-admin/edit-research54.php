...
$sql="UPDATE`research54` SET `name`='$name',`multiplier`='$multiplier',`percent`='$percent'  WHERE  `research54`.`id`='$id' ";
//echo $sql;
...
$filename="research541-".$id. "." .$ext;
copy($file,"../files/$filename");
$sql="update  `research54` set  filename='$filename' where id='$id' ";
$result = mysql_query($sql);
}
...
$filename2="research542-".$id. "." .$ext;
copy($file2,"../files/$filename2");
$sql="update  research54 set  filename2='$filename2' where id='$id' ";
$result = mysql_query($sql);
}
...
$filename3="research543-".$id. "." .$ext;
copy($file3,"../files/$filename3");
$sql="update  research54 set  filename3='$filename3' where id='$id' ";
$result = mysql_query($sql);
}
...
$filename4="research544-".$id. "." .$ext;
copy($file4,"../files/$filename4");
$sql="update  research54 set  filename4='$filename4' where id='$id' ";
$result = mysql_query($sql);
}
