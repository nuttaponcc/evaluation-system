...
<body>
  ...
  <table width="100%" border="0" cellspacing="10">
    <tr>
      <td align="left"><div class="style1">ค่าถ่วงน้ำหนัก</div></td>
    </tr>
    <tr>
      <td align="left" valign="top"><table width="100%" border="0" cellspacing="10" cellpadding="0">
          <tr>
            ...
                   คณาจารย์สามารถเลือกค่าถ่วงน้ำหนักที่ใช้ในการประเมิน วงรอบที่ 1 (1ตุลาคม 2555 - 31 มีนาคม 2556)<br />
        ...
        <form id="form1" name="form1" method="post" action="action/update-weight.php">
          <table border="1" cellpadding="5" cellspacing="0">
            <tr>
              ...
              <td align="center">การสอน(%)</td>
              <td align="center">งานวิจัย(%)</td>
              <td align="center">บริการวิชาการ(%)</td>
              <td align="center">ทำนุบำรุงฯ(%)</td>
              <td align="center">บริหารจัดการและอื่น ๆ (%)</td>
            </tr>
			<?
