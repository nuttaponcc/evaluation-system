...
<div align="left">
  ...
  <form action="action-admin/add-seminar.php?<? echo "userid=$userid" ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table border="0" cellpadding="5" bgcolor="#FFFFFF">
    <tr>
      <td align="left" valign="top" bgcolor="#FFDDFF">ชื่อ-นามสกุลนิสิต</td>
