...
$year=date("Y");
	    ...
	    $query2 = "SELECT * FROM  `staffinfo`  where staffinfo.staffmajor='ภาควิชาฟิสิกส์' or  staffinfo.staffid='513' or  staffinfo.staffid='348' or  staffinfo.staffid='437'  or  staffinfo.staffid='538'  ORDER BY staffname asc ";
