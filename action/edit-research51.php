...
$sql="UPDATE`research51` SET `name`='$name',`multiplier`='$multiplier',`percent`='$percent' WHERE  `research51`.`id`='$id' ";
//echo $sql;
...
$filename="research511-".$id. "." .$ext;
copy($file,"../files/$filename");
$sql="update  `research51` set  filename='$filename' where id='$id' ";
$result = mysql_query($sql);
}
...
$filename2="research512-".$id. "." .$ext;
copy($file2,"../files/$filename2");
$sql="update  research51 set  filename2='$filename2' where id='$id' ";
$result = mysql_query($sql);
}
...
$filename3="research513-".$id. "." .$ext;
copy($file3,"../files/$filename3");
$sql="update  research51 set  filename3='$filename3' where id='$id' ";
$result = mysql_query($sql);
}
...
$filename4="research514-".$id. "." .$ext;
copy($file4,"../files/$filename4");
$sql="update  research51 set  filename4='$filename4' where id='$id' ";
$result = mysql_query($sql);
}
