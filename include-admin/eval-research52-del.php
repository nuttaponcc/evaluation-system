...
<div align="left">
  <p><strong>ลบ </strong>
    <?php 
     	$query = "SELECT * FROM `research52`  where  `research52`.id=$id  and  userid=$userid ORDER BY date asc";
...
2.4) ผลงานวิชาการ<br />
2.4.2) เอกสารคำสอน <br />
  </p>
  <form action="action-admin/del-research52.php?<? echo "userid=$userid" ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
