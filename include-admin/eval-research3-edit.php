...
<div align="left">
  <p><strong>แก้ไข</strong>
    <?php 
     	$query = "SELECT * FROM `research3`  where  `research3`.id=$id  and  userid=$userid ORDER BY date asc";
  ...
  <form action="action-admin/edit-research3.php?<? echo "userid=$userid" ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
...
?>
   ...
   <td align="left" valign="top" bgcolor="#E9FAA3"><strong>ตัวคูณ=1 </strong>มีงานวิจัยตีพิมพ์เผยแพร่ในProceedings  ตามเกณฑ์ประกาศ ก.พ.อ. ที่ใช้ปัจจุบัน<br />
        <strong>ตัวคูณ=2 </strong>มีงานวิจัยตีพิมพ์เผยแพร่ใน  Proceedings ระดับนานาชาติ  หรือตีพิมพ์ในวารสารวิชาการที่ปรากฏในฐานข้อมูล TCIกลุ่ม 2<br />
