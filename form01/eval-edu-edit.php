...
<div align="left">
  <p><strong>แก้ไข</strong><?php 
     	$query = "SELECT * FROM  `edu`  where  `edu`.id=$id  and  userid='".$_SESSION[session_user_id]."' ORDER BY date asc";
  ...
  <form action="action/edit-edu.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
