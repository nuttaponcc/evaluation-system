...
<div align="left">
  <p><strong>ลบ</strong><?php 
     	$query = "SELECT * FROM `workload`,`is-advisor`  where  `is-advisor`.`workload`=workload.id and  `is-advisor`.id=$id  and  userid='".$_SESSION[session_user_id]."' ORDER BY date asc";
  ...
  <form action="action/del-is-advisor.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
