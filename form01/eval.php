...
<div align="center">
  <table width="100%" border="0" cellpadding="0" cellspacing="10" bgcolor="#999999">
    <tr>
      <td><strong><br />
แบบรายงานผลการปฏิบัติราชการของข้าราชการและพนักงาน สังกัดมหาวิทยาลัยมหาสารคาม </strong> <br />
แบบ ป.01<br />
<br />
...
<div align="center">
  ...
  <p>
  <? include "form01/eval1.php";?>
  <? include "form01/eval2.php";?>
  <? include "form01//eval3.php";?>
  <? include "form01//eval4.php";?>
  <? include "form01/eval5.php";?>
  </p>
