...
if($smajor!='คณะผู้บริหาร')$pdf->MultiCell(78,5,$sc70,0,'L');
$pdf->SetXY(110,10+$h*5);
if($smajor=='คณะผู้บริหาร')  $pdf->MultiCell(78,5,'                           '.$percent.'                     ',0,'L'); else  $pdf->MultiCell(78,5,'                           '.$percent.'                     '.$sc7.'',0,'L'); 
$pdf->SetXY(21,10+$h*7);
$pdf->MultiCell(78,5,'องค์ประกอบที่ 2 พฤติกรรมการปฏิบัติราชการ',0,'L');
$pdf->SetXY(110,10+$h*7);
if($smajor!='คณะผู้บริหาร')$pdf->MultiCell(78,5,$sc30,0,'L');
$pdf->SetXY(110,10+$h*7);
if($smajor=='คณะผู้บริหาร') $pdf->MultiCell(78,5,'                           '. (100-$percent) .'                     ',0,'L'); else$pdf->MultiCell(78,5,'                           '. (100-$percent) .'                     '.$sc3.'',0,'L');
$pdf->SetXY(21,10+$h*9);
$pdf->MultiCell(78,5,'องค์ประกอบอื่นๆ (ถ้ามี)',0,'L');
$pdf->SetXY(120,8+$h*11);
if($smajor=='คณะผู้บริหาร')  $pdf->MultiCell(78,5,'รวม             100                  ',0,'L'); else  $pdf->MultiCell(78,5,'รวม             100                   '.$sc100.'',0,'L'); 
/*
if($sc100<60){
