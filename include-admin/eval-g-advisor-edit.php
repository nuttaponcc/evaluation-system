...
<div align="left">
  <p><strong>แก้ไข</strong><?php 
     	$query = "SELECT * FROM `workload`,`graduate-advisor`  where  `graduate-advisor`.`workload`=workload.id and  `graduate-advisor`.id=$id  and  userid=$userid ORDER BY date asc";
  ...
  <form action="action-admin/edit-g-advisor.php?<? echo "userid=$userid" ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
