...
$year=date("Y");
	    ...
	    $query2 = "SELECT * FROM  `staffinfo`  where staffinfo.staffmajor='ภาควิชาชีววิทยา'  or  staffinfo.staffid='254' or  staffinfo.staffid='228' or  staffinfo.staffid='373' or  staffinfo.staffid='240'  ORDER BY staffname asc ";//or  staffinfo.staffid='133' 
 ...
 if($Mrow ['b']==2)
 {
  $str ="<td align=cenetr>คะแนนดิบด้านการสอน</td><td>score</td><td>level</td><td align=center>คะแนนดิบด้านวิจัย</td><td>score</td><td>level</td><td align=center>คะแนนดิบด้านการบริการวิชาการ(3.1-3.4)(3.5-3.6)</td><td>score</td><td>level</td><td align=center>คะแนนดิบด้านทำนุบำรุงศิลปะและวัฒนธรรม</td><td>score</td><td>level</td><td align=center>คะแนนดิบด้านช่วยการบริหาร<br>จัดการและอื่น ๆ(5.1)
(5.2-5.5)</td><td>score</td><td>level</td><td>ผลรวมของค่าคะแนน</td><td>%เต็ม1</td><td>เต็ม70%</td><td>เต็ม30%</td><td>เต็ม100%</td>";
  }else{
  $str="";
  }
  
  echo "<tr><td align=center>ลำดับที่</td><td align=center> ชื่อ </td>$str</tr>";
...
/***********จบคะแนนดิบ************/
		         ...
		         echo "<tr><td align=center>".$i++."</td><td >".$row2 ['staffname']."  </td>$str </td>
</tr>";
		 }
		 echo"</table>";
		 echo"</td></tr></table>";
