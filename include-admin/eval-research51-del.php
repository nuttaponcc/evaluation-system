...
<div align="left">
  <p><strong>ลบ </strong>
    <?php 
     	$query = "SELECT * FROM `research51`  where  `research51`.id=$id  and  userid=$userid ORDER BY date asc";
  ...
  <p>2. ภาระงานด้านวิจัย<br />
    2.4) ผลงานวิชาการ<br />
  2.4.1) เอกสารประกอบการสอน<br />
  </p>
  <form action="action-admin/del-research51.php?<? echo "userid=$userid" ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
...
?>
    ...
    <tr>
      ...
      <td align="left" valign="top" bgcolor="#E9FAA3"><? echo "<a href=\"files/".$row0[4]."\" >".$row0[4]."</a> " ?></td>
      <td align="left" valign="top" bgcolor="#E9FAA3">&nbsp;</td>
    </tr>
  </table>
    <p>
      <input name="ยืนยันการลบ" type="submit" id="ยืนยันการลบ" value="Submit" />
    </p>
  </form>
