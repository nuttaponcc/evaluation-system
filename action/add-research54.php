...
$sql="INSERT INTO `".$tname."` VALUES(NULL,'$session_user_id','$multiplier',0,'','$date_today','$year','$name','','','','$percent')";
...
$filename="research541-".$id_max. "." .$ext;
copy($file,"../files/$filename");

$sql="update  research54 set  filename='$filename' where id='$id_max' ";
$result = mysql_query($sql);
}
...
$filename2="research542-".$id_max. "." .$ext;
copy($file,"../files/$filename2");

$sql="update  research54 set  filename2='$filename2' where id='$id_max' ";
$result = mysql_query($sql);
...
$filename3="research543-".$id_max. "." .$ext;
copy($file3,"../files/$filename3");

$sql="update  research54 set  filename3='$filename3' where id='$id_max' ";
$result = mysql_query($sql);
...
$filename4="research544-".$id_max. "." .$ext;
copy($file,"../files/$filename4");

$sql="update  research54 set  filename4='$filename4' where id='$id_max' ";
$result = mysql_query($sql);
